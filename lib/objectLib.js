...
MLB.objectLib.findClosestObjects = function (minCount, maxDistanceDeg, minMagnitude) {
    var calcAngularSepUsingRaDec = MLB.coordLib.calcAngularSepUsingRaDec,
        ...
        catalog = MLB.Saguaro81.Saguaro81, //MLB.Saguaro81AbbrJson.Saguaro81Abbr,
    ...
    return filteredUniqueGroupsStr.length;
};
