...
MLB.sagittaCalc.calcUsingFocalLength = function () {
	var mirrorDecimals = 2,
		...
		sphereToParabolaDiff = calcSphereParabolaDifference(mirrorDia, focalRatio),
	...
	$('input[name=sphereParabolaDifference]').val(roundToDecimal(sphereToParabolaDiff, sphereToParabolaDecimals));
};
...
MLB.sagittaCalc.load = function () {
	var btnFocalLength = document.getElementById('btnFocalLength'),
		btnFocalRatio = document.getElementById('btnFocalRatio'),
		btnParabolicSagitta = document.getElementById('btnParabolicSagitta'),
		btnSphericalSagitta = document.getElementById('btnSphericalSagitta'),
