// copyright Mel Bartels, 2012-2016
...
MLB.sagittaCalc.calcCommonValues = function () {
	var mirrorDecimals = 2,
		...
		calcWavesCorrection = MLB.calcLib.calcWavesCorrection,
		...
		wavesCorrection = calcWavesCorrection(sphereToParabolaDiff),
	...
	$('input[name=wavesCorrection]').val(roundToDecimal(wavesCorrection, wavesCorrectionDecimals) + ' waves');
