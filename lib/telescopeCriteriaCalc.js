...
MLB.telescopeCriteriaCalc.config = {
    ...
    flexRockerLengthText: 'rocker length = ',
    flexRockerBaseRingHeightText: 'base ring height = ',
    flexRockerWidthText: 'rocker width = ',
...
MLB.telescopeCriteriaCalc.graphFlexRocker = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        ...
        altBearingRadius = CG.heightToClearRockerBottomDistance,
    ...
    azInnerRadius = Math.sqrt(altBearingSeparation * altBearingSeparation + altBearingSideToSideSeparation * altBearingSideToSideSeparation) / 2;
...
MLB.telescopeCriteriaCalc.updateFlexRockerStrategy = function (startup) {
...
MLB.telescopeCriteriaCalc.updateFrictionOfMovementStrategy = function (startup) {
    var updateFrictionOfMovement = MLB.telescopeCriteriaCalc.updateFrictionOfMovement,
        ...
        updateFlexRockerStrategy = MLB.telescopeCriteriaCalc.updateFlexRockerStrategy;

    updateFrictionOfMovement();
    graphRocker();
    updateFlexRockerStrategy(startup);
};
