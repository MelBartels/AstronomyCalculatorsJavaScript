...
MLB.telescopeCriteriaCalc.writeSummary = function (startup) {
	...
	comaFreeDiaFocalRatio = common.useComaCorrectorMagVal() ? 12 : focalRatio;
	common.summaryComaFreeDiameter().html(roundToDecimal(common.convertInchesToUom(calcComaFreeDiaInches(comaFreeDiaFocalRatio)), config.decimalPointsComaFreeDiameter) + uomLengthLit);
