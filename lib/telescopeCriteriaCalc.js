...
MLB.telescopeCriteriaCalc.common = {
	...
	btnCalcBestFitEyepiece: function () {
		return $('input[id=btnCalcBestFitEyepiece]');
	},
...
MLB.telescopeCriteriaCalc.calcBestFitEyepiece = function () {
	var common = MLB.telescopeCriteriaCalc.common,
		eyepiecesJson = MLB.eyepiecesJson,
		setSelectedEyepiece = MLB.telescopeCriteriaCalc.setSelectedEyepiece,
		targetEyepieceFLmm = common.focalRatioVal() * common.eyePupilmmVal(),
		bestFitEyepiece,
		bestFitDeviation,
		bestIx,
		eyepieceDeviation;
	...
	$.each(eyepiecesJson.eyepieces, function (i, v) {
		...
		if (bestFitDeviation == undefined || eyepieceDeviation < bestFitDeviation) {
...
MLB.telescopeCriteriaCalc.processFocalRatioChecked = function () {
	...
	if (focalRatioChecked !== state.focalRatioChecked) {
		if (focalRatioChecked) {
			...
			common.btnCalcBestFitEyepiece().removeAttr('disabled');
			...
			common.btnCalcBestFitEyepiece().attr('disabled', 'disabled');
...
$(window).ready(function () {
	var calcAperture = MLB.telescopeCriteriaCalc.calcAperture,
		...
		calcBestFitEyepiece = MLB.telescopeCriteriaCalc.calcBestFitEyepiece,
	...
	common.btnCalcBestFitEyepiece().click(function () {
		calcBestFitEyepiece();
	});
	...
	$.each(eyepiecesJson.eyepieces, function (i, v) {
		...
		common.eyepiecesElement().append(str);
	});
