...
MLB.telescopeCriteriaCalc.common = {
    ...
    radBtnETRockerType: function () {
        return $('[name=radBtnETRockerType]');
    },
    ...
    standardRockerChecked: function () {
        return this.radBtnETRockerType()[0].checked;
    },
...
MLB.telescopeCriteriaCalc.graphEquatorialTable = function () {
    ...
    // flex rocker...
    // base ring acts as the equatorial platform
