...
MLB.telescopeCriteriaCalc.common = {
	...
	limitingMagnitudeHighMagnification: function () {
		return $('input[name=limitingMagnitudeHighMagnification]');
	},
...
MLB.telescopeCriteriaCalc.commonT = {
	...
	limitingMagnitudeHighMagnification: function () {
		return $('input[name=limitingMagnitudeHighMagnificationT]');
	},
	apertureInchesVal: function () {
		return +this.apertureInches().val();
	},
...
MLB.telescopeCriteriaCalc.calcDisplayLimitingMagnitudeStrategy = function (common) {
	...
	common.limitingMagnitudeHighMagnification().val(roundToDecimal(highMagnificationMagnitudeLimit, decimalPointsMagLimit));
};
...
MLB.telescopeCriteriaCalc.calcApertureT = function () {
	var calcApertureStrategy = MLB.telescopeCriteriaCalc.calcApertureStrategy,
		...
		calcFunc = function () {
			return calcApertureFromFOV_FocalRatio_EyepieceFieldStop(common.FOVdegVal(), common.focalRatioVal(), common.eyepieceFieldStopmmVal());
		};
...
MLB.telescopeCriteriaCalc.calcFOVT = function () {
	var calcFOVStrategy = MLB.telescopeCriteriaCalc.calcFOVStrategy,
		...
		calcFunc = function () {
			return calcFOVFromAperture_FocalRatio_EyepieceFieldStop(common.apertureInchesVal(), common.focalRatioVal(), common.eyepieceFieldStopmmVal());
		};
...
MLB.telescopeCriteriaCalc.calcEyepieceFieldStopT = function () {
	var calcEyepieceFieldStopStrategy = MLB.telescopeCriteriaCalc.calcEyepieceFieldStopStrategy,
		...
		calcFunc = function () {
			return calcEyepieceFieldStopFromAperture_FOV_FocalRatio(common.apertureInchesVal(), common.FOVdegVal(), common.focalRatioVal());
		};
