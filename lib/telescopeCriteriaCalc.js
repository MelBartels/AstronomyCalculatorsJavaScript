...
MLB.telescopeCriteriaCalc.config = {
	...
	fieldHighlightColor: '#ffcccc',
	fieldDefaultColor: '#ffffff',
	fieldAperture_FocalRatio_FocalLength: '#ccccff'
};
...
MLB.telescopeCriteriaCalc.processFocalRatioChecked = function () {
	...
	if (focalRatioChecked !== state.focalRatioChecked) {
		if (focalRatioChecked) {
			...
			common.apertureInches().css({backgroundColor: config.fieldHighlightColor});
			common.focalRatio().css({backgroundColor: config.fieldHighlightColor});
			common.FOVdeg().css({backgroundColor: config.fieldHighlightColor});
			common.eyepieceFieldStopmm().css({backgroundColor: config.fieldHighlightColor});

			common.eyePupilmm().css({backgroundColor: config.fieldDefaultColor});
			common.eyepieceFocalLengthmm().css({backgroundColor: config.fieldDefaultColor});
			...
			common.apertureInches().css({backgroundColor: config.fieldHighlightColor});
			common.FOVdeg().css({backgroundColor: config.fieldHighlightColor});
			common.eyePupilmm().css({backgroundColor: config.fieldHighlightColor});
			common.eyepieceFocalLengthmm().css({backgroundColor: config.fieldHighlightColor});
			common.eyepieceFieldStopmm().css({backgroundColor: config.fieldHighlightColor});

			common.focalRatio().css({backgroundColor: config.fieldAperture_FocalRatio_FocalLength});
