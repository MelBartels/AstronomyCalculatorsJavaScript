...
MLB.telescopeCriteriaCalc.calcEyepieceWidestFieldForEyePupil = function () {
    ...
    $.each(eyepiecesJson.eyepieces, function (i, v) {
	    if (focalRatioChecked) {
			...
			FOV = calcFOVFromAperture_EyepieceFL_EyepieceFieldStop_EyePupil(common.apertureInchesVal(), common.eyepieceFocalLengthmmVal(), +v.fieldStopmm, common.eyePupilmmVal());
		}
