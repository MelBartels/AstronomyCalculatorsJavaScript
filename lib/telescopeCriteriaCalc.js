...
MLB.telescopeCriteriaCalc.graphBaffles = function () {
    ...
    // calc telescope tube
    telescopeTubeRect = rect(tubeRearEndFrontCenterPt.x, tubeRearEndFrontCenterPt.y - scaledTelescopeTubeOD / 2, projectedFocuserBaffleRightPt.x - tubeRearEndFrontCenterPt.x, scaledTelescopeTubeOD);
    ...
    */
    ...
    drawLine(context, config.canvasBaffleStyle, config.canvasLineWidth, point(primaryMirrorBaffleUpperRect.endX, primaryMirrorBaffleUpperRect.endY), diagUpperPt);
    ...
    common.baffleResults().html('mirror sagitta = '
