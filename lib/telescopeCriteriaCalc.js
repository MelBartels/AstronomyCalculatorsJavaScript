...
MLB.telescopeCriteriaCalc.config = {
	...
	rockerSideLengthText: 'rocker side = ',
...
MLB.telescopeCriteriaCalc.graphRocker = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		CGPt,
		rockerBottomBoardTopRightPt,
		rockerBottomBoardTopLeftPt,
		rockerBottomBoardBottomRightPt,
		rockerBottomBoardBottomLeftPt,
		rockerSideTopRightPt,
		rockerSideTopLeftPt,
		rockerFrontBoardBottomRightPt,
		rockerFrontBoardTopRightPt,
		bearingArcLeftPt,
		bearingArcRightPt,
	...
	rockerSideLength = altBearingSeparation > telescopeTubeOD ? altBearingSeparation : telescopeTubeOD;
    ...
    // canvas 0,0 is upper left; x is horizontal coordinate, y is vertical coordinate
	// calc key points
	CGPt = point(canvas.width / 3, 4 * config.canvasDimensionHalfHeight);
	// rocker bottom board
	rockerBottomBoardTopRightPt = point(CGPt.x + scaledRockerSideLength / 2, CGPt.y + scaledCGHeightToClearRockerBottomDistance);
	rockerBottomBoardTopLeftPt = point(CGPt.x - scaledRockerSideLength / 2, CGPt.y + scaledCGHeightToClearRockerBottomDistance);
	rockerBottomBoardBottomRightPt = point(rockerBottomBoardTopRightPt.x, rockerBottomBoardTopRightPt.y + scaledWoodThickness);
	rockerBottomBoardBottomLeftPt = point(rockerBottomBoardTopLeftPt.x, rockerBottomBoardBottomRightPt.y);
	// rocker side
	rockerSideTopRightPt = point(rockerBottomBoardTopRightPt.x, rockerBottomBoardTopRightPt.y - scaledRockerSideHeight);
	rockerSideTopLeftPt = point(rockerBottomBoardTopLeftPt.x, rockerSideTopRightPt.y);
	// rocker front board
	rockerFrontBoardBottomRightPt = point(rockerBottomBoardBottomRightPt.x + scaledWoodThickness, rockerBottomBoardBottomRightPt.y);
	rockerFrontBoardTopRightPt = point(rockerFrontBoardBottomRightPt.x, rockerSideTopRightPt.y);
	// bearing arc
	bearingArcLeftPt = point(CGPt.x - state.scalingFactor * altBearingRadius * Math.sin(altBearingSeparationHalfAngleRad), CGPt.y + state.scalingFactor * altBearingRadius * Math.cos(altBearingSeparationHalfAngleRad));
	...
	bearingArcLeftIntersectWithRockerSideTopPt = point(bearingArcLeftPt.x, rockerSideTopLeftPt.y);
	bearingArcRightIntersectWithRockerSideTopPt = point(bearingArcRightPt.x, rockerSideTopRightPt.y);
    ...
    // draw rocker ground board
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardTopLeftPt, rockerBottomBoardTopRightPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardBottomLeftPt, rockerBottomBoardBottomRightPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardTopLeftPt, rockerBottomBoardBottomLeftPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardTopRightPt, rockerBottomBoardBottomRightPt);
	// draw rocker side
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerSideTopLeftPt, rockerSideTopRightPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardTopLeftPt, rockerSideTopLeftPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerBottomBoardTopRightPt, rockerSideTopRightPt);
	// draw rocker front board
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerFrontBoardTopRightPt, rockerFrontBoardBottomRightPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerFrontBoardBottomRightPt, rockerBottomBoardBottomRightPt);
    drawLine(context, config.canvasStructureStyle, config.canvasLineWidth, rockerFrontBoardTopRightPt, rockerSideTopRightPt);
    // draw bearing arc
    context.beginPath();
    ...
    context.font = config.canvasFont;
    context.fillStyle = config.canvasStructureLightStyle;
    dimension = roundToDecimal(altBearingSeparation, config.decimalPointsDimension) + uomLengthLit;
    dimensionY = rockerBottomBoardBottomLeftPt.y + 4 * config.canvasDimensionHalfHeight;
    dimensionRightPt = point(bearingArcRightPt.x, dimensionY);
    dimensionLeftPt = point(bearingArcLeftPt.x, dimensionY);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, dimensionLeftPt, dimensionRightPt);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionLeftPt.x, dimensionLeftPt.y - config.canvasDimensionHalfHeight), point(dimensionLeftPt.x, dimensionLeftPt.y + config.canvasDimensionHalfHeight));
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionRightPt.x, dimensionRightPt.y - config.canvasDimensionHalfHeight), point(dimensionRightPt.x, dimensionRightPt.y + config.canvasDimensionHalfHeight));
    context.fillText(config.altitudeBearingSeparation + dimension, dimensionLeftPt.x + config.canvasTextBorder, dimensionY - config.canvasTextBorder);
    // write horizontal dimension for rocker side length
    context.font = config.canvasFont;
    context.fillStyle = config.canvasStructureLightStyle;
    dimension = roundToDecimal(rockerSideLength, config.decimalPointsDimension) + uomLengthLit;
    dimensionY += 4 * config.canvasDimensionHalfHeight;
    dimensionRightPt = point(rockerBottomBoardBottomRightPt.x, dimensionY);
    dimensionLeftPt = point(rockerBottomBoardBottomLeftPt.x, dimensionY);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, dimensionLeftPt, dimensionRightPt);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionLeftPt.x, dimensionLeftPt.y - config.canvasDimensionHalfHeight), point(dimensionLeftPt.x, dimensionLeftPt.y + config.canvasDimensionHalfHeight));
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionRightPt.x, dimensionRightPt.y - config.canvasDimensionHalfHeight), point(dimensionRightPt.x, dimensionRightPt.y + config.canvasDimensionHalfHeight));
    context.fillText(config.rockerSideLengthText + dimension, dimensionLeftPt.x + config.canvasTextBorder, dimensionY - config.canvasTextBorder);
    // write vertical dimension for rocker side height
    context.font = config.canvasFont;
    context.fillStyle = config.canvasStructureLightStyle;
    dimension = roundToDecimal(rockerSideHeight, config.decimalPointsDimension) + uomLengthLit;
    dimensionX = rockerFrontBoardTopRightPt.x + 4 * config.canvasDimensionHalfHeight;
    dimensionTopPt = point(dimensionX, rockerSideTopRightPt.y);
    dimensionBottomPt = point(dimensionX, rockerBottomBoardTopRightPt.y);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, dimensionBottomPt, dimensionTopPt);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionBottomPt.x - config.canvasDimensionHalfHeight, dimensionBottomPt.y), point(dimensionBottomPt.x + config.canvasDimensionHalfHeight, dimensionBottomPt.y));
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionTopPt.x - config.canvasDimensionHalfHeight, dimensionTopPt.y), point(dimensionTopPt.x + config.canvasDimensionHalfHeight, dimensionTopPt.y));
    context.fillText(config.rockerSideLengthText + dimension, dimensionX + config.canvasTextBorder, (rockerBottomBoardBottomRightPt.y + rockerSideTopRightPt.y) / 2);
    // write vertical dimension for pad board height
    context.font = config.canvasFont;
    context.fillStyle = config.canvasStructureLightStyle;
	padHeight = rockerSideTopRightPt.y - bearingArcRightPt.y;
    dimension = roundToDecimal(padHeight / state.scalingFactor, config.decimalPointsDimension) + uomLengthLit;
    dimensionTopPt = point(dimensionX, bearingArcRightPt.y);
    dimensionBottomPt = point(dimensionX, rockerSideTopRightPt.y);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, dimensionBottomPt, dimensionTopPt);
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionBottomPt.x - config.canvasDimensionHalfHeight, dimensionBottomPt.y), point(dimensionBottomPt.x + config.canvasDimensionHalfHeight, dimensionBottomPt.y));
    drawLine(context, config.canvasStructureLightStyle, config.canvasLineWidth, point(dimensionTopPt.x - config.canvasDimensionHalfHeight, dimensionTopPt.y), point(dimensionTopPt.x + config.canvasDimensionHalfHeight, dimensionTopPt.y));
    context.fillText(config.padHeightText + dimension, dimensionX + config.canvasTextBorder, (bearingArcRightPt.y + rockerSideTopRightPt.y) / 2);
