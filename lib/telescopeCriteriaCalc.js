...
MLB.telescopeCriteriaCalc.common = {
	...
	offaxisMaskNotes: function () {
		return $('[id=offaxisMaskNotes]');
	},
	...
	frictionOfMovementNotes: function () {
        return $('[id=frictionOfMovementNotes]');
    },
...
MLB.telescopeCriteriaCalc.updateSpecs = function () {
    ...
    common.specs().html('telescope focal length = '
...
MLB.telescopeCriteriaCalc.writeOffaxisMaskNotes = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.telescopeCriteriaCalc.config,
        common = MLB.telescopeCriteriaCalc.common,
		calcTheoreticalResolutionArcsec = MLB.calcLib.calcTheoreticalResolutionArcsec,
	...
	common.offaxisMaskNotes().html('maximum off-axis diameter = '
...
MLB.telescopeCriteriaCalc.graphDiagIllum = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		writeOffaxisMaskNotes = MLB.telescopeCriteriaCalc.writeOffaxisMaskNotes;
...
MLB.telescopeCriteriaCalc.graphBaffles = function () {
    ...
    */
    ...
    // write out notes
    common.baffleNotes().html('mirror sagitta = ' + roundToDecimal(sagitta, config.decimalPointsDimension) + uomLengthLit);
};
...
MLB.telescopeCriteriaCalc.updateFrictionOfMovement = function () {
    ...
    common.frictionOfMovementNotes().html('Altitude friction of movement at eyepiece = '
...
$(window).ready(function () {
	...
	*/
	...
	$('[id^=optimizerHeader').each(function (idIx) {
		$(this).click(function () {
			$('[id=optimizerDetail' + idIx + ']').toggle();
			// return false to keep page focused at current location
			return false;
		});
	});
