...
MLB.encoderLib.encoder = function () {
	this.name = undefined;
...
MLB.encoderLib.encoderBuilder = function (name, minCount, maxCount, gearReduction) {
	var encoder = new MLB.encoderLib.encoder();
...
MLB.encoderLib.calcMotorEncoderTicksResolution = function (encoder) {
...
*/
MLB.encoderLib.getDirection = function (encoder) {
...
MLB.encoderLib.setRotations = function (encoder) {
...
MLB.encoderLib.setAngles = function (encoder) {
	var uom = MLB.sharedLib.uom,
...
MLB.encoderLib.update = function (encoder, count) {
	var getDirection = MLB.encoderLib.getDirection,
...
MLB.encoderLib.reset = function (encoder) {
...
MLB.encoderLib.setToAngle = function (encoder, angleRad) {
	var uom = MLB.sharedLib.uom,
