...
MLB.meniscusMirrorMakingClass.calculateMirrorWeight = function (form) { // form passes itself via this.form
...
MLB.meniscusMirrorMakingClass.calculateToolVolume = function (form) { // form passes itself via this.form
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
...
MLB.meniscusMirrorMakingClass.calcSphereToParabolaDifference = function (form) { // form passes itself via this.form
