...
// uses calcDiagOffset3() after computing vantage point based on field diameter
MLB.calcLib.calcDiagOffset4 = function (diagMinorAxis, diagToFocalPlaneDistance, fieldDia, focalRatio) {
	return MLB.calcLib.calcDiagOffset3(diagMinorAxis, diagToFocalPlaneDistance + fieldDia * focalRatio);
};

// returns two offsets: one based on the focal plane and one based on the field diameter
MLB.calcLib.calcDiagOffset5 = function (diagMinorAxis, diagToFocalPlaneDistance, fieldDia, focalRatio) {
	return {
		focalPlaneOffset: MLB.calcLib.calcDiagOffset3(diagMinorAxis, diagToFocalPlaneDistance),
		fieldDiaOffset: MLB.calcLib.calcDiagOffset4(diagMinorAxis, diagToFocalPlaneDistance, fieldDia, focalRatio)
	};
}
