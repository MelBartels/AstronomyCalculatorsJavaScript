...
MLB.calcLib.calcBinoscope = function (mirrorDia, focalRatio, tertiaryOffsetFromEdgeOfPrimary, focalPointToTertiaryDistance, focalPointToSecondaryDistance) {
    var secondaryToTiertiaryDistance,
    ...
    anglePrimaryMirrorEdgeToFocalPointRad = Math.atan(mirrorDia / 2 / (mirrorDia * focalRatio));
