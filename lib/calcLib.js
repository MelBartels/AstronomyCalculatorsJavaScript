...
MLB.calcLib.calcBinoscope = function (mirrorDia, focalRatio, tertiaryOffsetFromEdgeOfPrimary, focalPointToTertiaryDistance, focalPointToSecondaryDistance, fieldDia) {
    ...
    secondaryToTertiaryDistance = focalPointToSecondaryDistance - focalPointToTertiaryDistance;
    ...
    tertiarySizedForP3ToSecondaryRatio = focalPointToTertiaryDistance / focalPointToSecondaryDistance;
    ...
    P2centerXLengthFromSecondaryCenter = Math.cos(elbowAngleRad) * focalPointToSecondaryDistance;
    P2centerYLengthFromSecondaryCenter = Math.sin(elbowAngleRad) * focalPointToSecondaryDistance;
    ...
    // r2X is the same but for the left hand side of the P2 field edge to teh secondary edge
