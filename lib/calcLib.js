...
MLB.calcLib.calcBinoscope = function (mirrorDia, focalRatio, tertiaryOffsetFromEdgeOfPrimary, focalPlaneToTertiaryDistance, focalPlaneToSecondaryDistance, fieldDia) {
    ...
    if (secondaryToTertiaryDistance - secondaryToTertiaryVerticalLength < 0) {
        console.log('warning: MLB.calcLib.calcBinoscope: secondaryToTertiaryDistance - secondaryToTertiaryVerticalLength < 0; secondaryToTertiaryDistance = '
                + secondaryToTertiaryDistance
                + ', secondaryToTertiaryVerticalLength = '
                + secondaryToTertiaryVerticalLength);
        secondaryToTertiaryHorizontalLength = 0;
    } else {
