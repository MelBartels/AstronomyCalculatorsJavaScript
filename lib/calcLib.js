...
// per communication from Steve Taylor
MLB.calcLib.calcPlaster = function (mirrorDia, mirrorFocalRatio, plasterEdgeThickness) {
    var calcSagittalVolume = MLB.calcLib.calcSagittalVolume,
        ...
        quartsWater = totalVolume / 80,
        poundsPlaster = quartsWater * 3;

    return {
        quartsWater: quartsWater,
        poundsPlaster: poundsPlaster
    };
};
