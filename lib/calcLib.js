...
MLB.calcLib.VisualDetectCalc = function () {
    ...
    this.calc = function (parms) {
        ...
        // object brightness
        surfBrightObj = getMagnitudeFromIllum(getIllumFromMagnitude(parms.objMag) / (uom.sqrArcminToSqrArcsec * parms.minObjArcmin * parms.maxObjArcmin));
    ...
    this.includeResultAsString = function (result) {
        ...
        s = 'input values:\n' +
            ...
            '  object surface brightness MPAC: ' + r.surfBrightObj + '\n' +
            '  object + sky brightness MPAC: ' + r.objPlusBkgnd + '\n' +
            '  at X:\n' +
            '    object size deg: ' + r.objSizeDegAtX + '\n' +
            '    brightness reduction: ' + r.illumReductionAtX + '\n' +
            '    object surface brightness MPAC: ' + r.surfBrightObjAtX + '\n' +
            '    sky MPAC: ' + r.bkgndBrightAtX + '\n' +
            '    object+sky surface brightness MPAC: ' + r.surfBrightObjPlusBkgndAtX + '\n' +
    ...
    this.includeResultAsJSON = function (result) {
        ...
        json = [
            ...
            {label: 'object surface brightness MPAC', result: rnd(r.surfBrightObj)},
            {label: 'object+sky brightness MPAC', result: rnd(r.objPlusBkgnd)},
            {label: 'illumination multipler at \'X\'', result: rnd(r.illumReductionAtX)},
            {label: 'object size deg at X', result: r.objSizeDegAtX},
            {label: 'object brightness at \'X\' MPAC', result: rnd(r.surfBrightObjAtX)},
            {label: 'sky background brightness at \'X\' MPAC', result: rnd(r.bkgndBrightAtX)},
            {label: 'object+sky at \'X\' MPAC', result: rnd(r.surfBrightObjPlusBkgndAtX)},
