...
// difference between sphere and parabola in waves of green light
MLB.calcLib.calcSphereParabolaDiff = function (mirrorDia, radiusOfCurvature) {
    return Math.pow(mirrorDia, 4) / Math.pow(radiusOfCurvature, 3) / 128 / 0.000022;
};
