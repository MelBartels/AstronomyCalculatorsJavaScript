...
MLB.visualDetectionCalc.plot = function () {
	...
	aperture = +document.getElementsByName('aperture')[0].value;
	bkgndBrightEye = +document.getElementsByName('bkgndBrightEye')[0].value;
	objName = document.getElementsByName('objName')[0].value;
	objMag = +document.getElementsByName('objMag')[0].value;
	objSize1 = +document.getElementsByName('objSize1')[0].value;
	objSize2 = +document.getElementsByName('objSize2')[0].value;
	...
	document.getElementsByName('limitMag')[0].value = roundToDecimal(formattedLimitMag - 1, 1) + ' to ' + formattedLimitMag;
