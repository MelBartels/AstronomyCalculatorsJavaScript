...
MLB.diagonal.graphDiags = function () {
    ...
    */
    ...
    offset = -calcDiagOffset3(suitableDiags[0], diagToFocalPlaneDistance);
    common.offset().html(roundToDecimal(offset, digits) + selectedUomAbbrev + '.');
    common.diagSizeMinObstruct().html(roundToDecimal(minDiag + offset / focalRatio, digits) + selectedUomAbbrev + '.');
