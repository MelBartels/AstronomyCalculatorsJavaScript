...
MLB.diagonal.graphDiags = function () {
	...
	offsets = calcDiagOffset5(suitableDiags[0], diagToFocalPlaneDistance, maxField, focalRatio);
	common.offset().html('varies from '
        + roundToDecimal(offsets.fieldDiaOffset, digits)
        + selectedUomAbbrev
        + ' at the focal point to '
        + roundToDecimal(offsets.focalPlaneOffset, digits)
        + selectedUomAbbrev
