...
MLB.diagonal.graphDiag = function () {
	...
	diagToFocalPlaneDistance = +document.getElementsByName('diagToFocalPlaneDistance')[0].value;
	focalLen = +document.getElementsByName('focalLen')[0].value;
	mirrorDia = +document.getElementsByName('mirrorDia')[0].value;
	maxField = parseFloat(+document.getElementsByName('maxField')[0].value);
	acceptableMagLoss = parseFloat(+document.getElementsByName('acceptableMagLoss')[0].value);
	diagSize = parseFloat(+document.getElementsByName('diagSize')[0].value);
