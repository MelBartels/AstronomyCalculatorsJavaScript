...
MLB.ronchi.processImage = (imageData, newImageData, canvasSize, RonchigramSize) => {
    ...
    for (yIx = 0; yIx < canvasSize; yIx++) {
        ...
        for (xIx = 0; xIx < canvasSize; xIx++) {
            canCalcGradient[yIx][xIx] = yIx > 0
                    && yIx < canvasSize - 1
                    && xIx > 0
                    && xIx < canvasSize - 1
                    && inNullRonchigram[yIx - 1][xIx - 1]
                    && inNullRonchigram[yIx - 1][xIx]
                    && inNullRonchigram[yIx - 1][xIx + 1]
                    && inNullRonchigram[yIx][xIx - 1]
                    && inNullRonchigram[yIx][xIx]
                    && inNullRonchigram[yIx][xIx + 1]
                    && inNullRonchigram[yIx + 1][xIx - 1]
                    && inNullRonchigram[yIx + 1][xIx]
                    && inNullRonchigram[yIx + 1][xIx + 1];
    ...
    for (yIx = 0; yIx < canvasSize; yIx++) {
        ...
        for (xIx = 0; xIx < canvasSize; xIx++) {
            if (canCalcGradient[yIx][xIx]) {
                ...
                gradient = 1 / 4 * (
                        + -nullRonchigramGrayscale[yIx - 1][xIx - 1]
                        + nullRonchigramGrayscale[yIx - 1][xIx + 1]
                        + -2 * nullRonchigramGrayscale[yIx][xIx - 1]
                        + 2 * nullRonchigramGrayscale[yIx][xIx + 1]
                        + -nullRonchigramGrayscale[yIx + 1][xIx - 1]
                        + nullRonchigramGrayscale[yIx + 1][xIx + 1]);
    ...
    for (yIx = 0; yIx < canvasSize; yIx++) {
        for (xIx = 0; xIx < canvasSize; xIx++) {
            if (canCalcGradient[yIx][xIx]) {
                ...
                newData[imgIx] = normalizedGradient;
                newData[imgIx + 1] = normalizedGradient;
                newData[imgIx + 2] = normalizedGradient;
            }
        }
    }
