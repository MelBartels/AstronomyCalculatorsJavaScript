...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, RonchiGrid, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, displayUnwrappedRonchigram, unwrapY, stretchX, distortionResolutionFactor, unwrapBandRuler
          ...
          '25': [25.1,   131,  0,  65,  0.776,  1, 400, 10,  true, false, false,  0.9, 454, 461, -16, -19, MLB.base64images._25,   true, false, 1.75, 2,  true],
           '6': [ 5.9,  33.9,  0, 100,  0.294,  1, 400, 10,  true, false, false,  0.9, 530, 496, -60, -40, MLB.base64images._6,    true, false, 1.75, 2,  true],
          '13': [13.1,  80.6,  0,  66, -0.104,  1, 400,  0, false, false, false, 0.75, 400, 400,   0,   0, MLB.base64images._13,   true, false, 1,    3, false],
        'grid': [13.1,  80.6,  0,  65, -0.454,  1, 400,  0,  true, true,  true,   0.9, 398, 402,   0,  -5, MLB.base64images._grid, true,  true, 1,    2,  true]
    },
    images: {},
...
MLB.ronchi.adjustRonchigramDivDiscussionDivWidths = function () {
    var constants = MLB.ronchi.constants,
        ...
        displayUnwrappedRonchigram = constants.displayUnwrappedRonchigram,
        RonchigramCount = constants.RonchigramCount,
        divWidth;

    divWidth = RonchigramCount * (RonchigramAndBorderSize + 40);
    if (displayUnwrappedRonchigram) {
