...
MLB.ronchi.calcMirrorSurfaceProfile = function () {
    ...
    for (ix = 0; ix < constants.zoneCount; ix++) {
        ...
        idealZonalRoC = radiusOfCurvature + mirrorZoneSquared / radiusOfCurvature;
...
/*
    console.log("start...");
    zones.forEach((z, ix) => {
        // x is the zonal height difference; y should not change much
        console.log(z.ideal.connectedEndX - z.actual.connectedEndX);
    });
    console.log("...end");
 */
