...
MLB.ronchi.wavefrontError = function (mirrorDia, radiusOfCurvature, correctionFactor) {
...
MLB.ronchi.findAllowableCorrection = function (mirrorDia, radiusOfCurvature) {
	var wavefrontError = MLB.ronchi.wavefrontError,
	    iterations = 0,
	    maxIterations = 8,
		lastWavefrontError,
...
MLB.ronchi.calcAllowableParabolicDeviationForQuarterWavefront = function (focalRatio) {
...
MLB.ronchi.plot = function () {
	var canvas,
		...
		calcAllowableParabolicDeviationForQuarterWavefront = MLB.ronchi.calcAllowableParabolicDeviationForQuarterWavefront,
	...
	mirrorDia = +document.getElementsByName('mirrorDia')[0].value;
	radiusOfCurvature = +document.getElementsByName('radiusOfCurvature')[0].value;
	gratingFreq = +document.getElementsByName('gratingFreq')[0].value;
	gratingOffsets = [+document.getElementsByName('gratingOffset1')[0].value, +document.getElementsByName('gratingOffset2')[0].value, +document.getElementsByName('gratingOffset3')[0].value];
