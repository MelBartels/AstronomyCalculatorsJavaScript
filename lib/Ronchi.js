...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY
        '16in':  [16.25, 93.6, 0,  65, -0.05, 1, 500, 0,  true, true, 0.86, 500, 500,   0,   0, '16/final Ronchigram inside RoC.jpg'],
        '16out': [16.25, 93.6, 0,  65, 0.674, 1, 500, 0,  true, true, 0.86, 500, 500,   0,   0, '16/final Ronchigram outside RoC.jpg'],
        '25':    [25.1, 131,   0,  65, 0.776, 1, 400, 10, true, true, 0.8,  454, 461, -16, -19, 'RonchiExamples/25 example.jpg'],
        '13':    [13.1,  80.6, 0,  65, 0.570, 1, 250, 10, true, true, 0.75, 304, 320, -20, -28, 'RonchiExamples/13 example.jpg'],
        '10':    [10.4,  58.4, 0, 100, 0.362, 1, 400, 10, true, true, 0.9,  416, 428,   7,  -5, 'RonchiExamples/10 example.jpg'],
        '6':     [5.9,   33.9, 0, 100, 0.294, 1, 400, 10, true, true, 0.9,  530, 496, -60, -40, 'RonchiExamples/6 example.jpg']
    },
