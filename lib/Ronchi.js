...
MLB.ronchi.adjustRonchigramDivDiscussionDivWidths = function () {
    ...
    constants.discussionDiv().width(screen.width - divWidth - 70);
};
...
MLB.ronchi.adjustZonalErrorsNotesDiv = function () {
    ...
    constants.zonalErrorsNotesDiv().width(Math.floor(screen.width - constants.zonalErrorsTableDiv().width() - constants.zonalErrorsViewDiv().width() - 120));
};
