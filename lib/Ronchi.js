...
MLB.ronchi.calcUnwrapVerticalStdDeviation = function () {
    ...
    constants.unwrapStraightnessLabel().html('Unwrap band straightness factor (lower is better) = '
            + int(totalStdDeviation)
            + '.<br>'
            + (totalStdDeviation < constants.lastTotalStdDeviation ? '(better than before)' : '(worse than before)'),
            + '.');
