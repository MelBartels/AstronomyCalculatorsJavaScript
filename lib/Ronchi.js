...
MLB.ronchi.quadrantsSetPixels = function (imageData, circleCenter) {
    var constants = MLB.ronchi.constants,
        pixelArray = constants.pixelArray,
        ...
        for (y = 0; y < xyLength; y += 1) {
            if (RonchiGrid) {
                if (pixelArray[x][y] === 2) {
                    ...
                    setPixel(imageData, circleCenter.x + x, circleCenter.y + y, gridRed, gridGreen, gridBlue, opaque);
                    setPixel(imageData, circleCenter.x - x, circleCenter.y + y, gridRed, gridGreen, gridBlue, opaque);
                    setPixel(imageData, circleCenter.x + x, circleCenter.y - y, gridRed, gridGreen, gridBlue, opaque);
                    setPixel(imageData, circleCenter.x - x, circleCenter.y - y, gridRed, gridGreen, gridBlue, opaque);
                }
...
MLB.ronchi.drawRonchigramOnCanvas = function (canvas, gratingOffset, userParabolicCorrection) {
    var constants = MLB.ronchi.constants,
        ...
        quadrantsSetPixels = MLB.ronchi.quadrantsSetPixels,
    ...
    processPixelArray();
    quadrantsSetPixels(imageData, ronchiCenter);
