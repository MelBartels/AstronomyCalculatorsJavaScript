...
MLB.ronchi.plotMirrorSurfaceProfile = function () {
    ...
    MSPChartData.forEach(d => {
        ...
        // save highest y value (appears as bottom most)
        if (y > highestZoneY) {
            highestZoneY = y;
        }
    });
    ...
    // draw line denoting lowest zone
    highestZoneY += constants.rulerThickness * 2;
    drawLine(context, constants.blackColor, constants.rulerThickness, point(0, highestZoneY), point(MSPChartSize.x, highestZoneY));
};
