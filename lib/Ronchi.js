...
MLB.ronchi.constants = {
    ...
    RoCoffsetStepsize: function () {
        return $('[id=RoCoffsetStepsize]');
    },
...
MLB.ronchi.setRoCoffsetFromGratingOffset = function () {
    var constants = MLB.ronchi.constants,
        decodeGratingOffsetSeries = MLB.ronchi.decodeGratingOffsetSeries;

    constants.RoCoffset().val(decodeGratingOffsetSeries()[0]);
};

MLB.ronchi.setGratingOffsetFromRoCoffset = function () {
    var constants = MLB.ronchi.constants;

    constants.gratingOffsetSeries().val(constants.RoCoffset().val());
};

MLB.ronchi.updateRoCoffsetStepsize = function () {
    var constants = MLB.ronchi.constants;

    constants.RoCoffset().attr('step', constants.RoCoffsetStepsize().val());
};
...
MLB.ronchi.plotRonchigramsUsingSliderOffset = function (sliderOffset) {
    var constants = MLB.ronchi.constants,
        roundToDecimal = MLB.sharedLib.roundToDecimal,
        decodeGratingOffsetSeries = MLB.ronchi.decodeGratingOffsetSeries,
    ...
    gratingOffsetSeriesValues = decodeGratingOffsetSeries();
    gratingOffsetSeriesValuesLength = gratingOffsetSeriesValues.length;
    sliderOffsetValue = parseFloat(sliderOffset().val());
...
MLB.ronchi.pasteExampleRonchigram = function (exampleImage) {
    ...
    constants.RoCoffset().val(exampleImage[ix++]);
...
MLB.ronchi.setupSliderOffset = function (sliderOffset) {
    var setRoCoffsetFromGratingOffset = MLB.ronchi.setRoCoffsetFromGratingOffset,
        plotRonchigramsUsingSliderOffset = MLB.ronchi.plotRonchigramsUsingSliderOffset;

    sliderOffset().mousemove(function () {
        setRoCoffsetFromGratingOffset();
        plotRonchigramsUsingSliderOffset(sliderOffset);
    });
    sliderOffset().mousedown(function () { MLB.ronchi.constants.sliderOffsetMousedown = true; });
    sliderOffset().mouseup(function () { MLB.ronchi.constants.sliderOffsetMousedown = false; });
};
...
$(window).ready(function () {
    var constants = MLB.ronchi.constants,
        ...
        plotRonchigrams = MLB.ronchi.plotRonchigrams,
        plotRonchigramsUsingSliderOffset = MLB.ronchi.plotRonchigramsUsingSliderOffset,
        setGratingOffsetFromRoCoffset = MLB.ronchi.setGratingOffsetFromRoCoffset,
        ...
        setupSliderOffset = MLB.ronchi.setupSliderOffset,
        setRoCoffsetFromGratingOffset = MLB.ronchi.setRoCoffsetFromGratingOffset,
        updateRoCoffsetStepsize = MLB.ronchi.updateRoCoffsetStepsize;
    ...
    constants.gratingOffsetSeries().change(function () {
        setRoCoffsetFromGratingOffset();
        plotRonchigrams();
    });
    ...
    constants.RoCoffset().change(function () {
        setGratingOffsetFromRoCoffset();
        plotRonchigrams();
    });
    constants.RoCoffsetStepsize().change(updateRoCoffsetStepsize);

    setupSliderOffset(constants.sliderOffset);
    setupSliderOffset(constants.sliderOffset2);
