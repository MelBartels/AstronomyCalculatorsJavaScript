...
MLB.ronchi.processZonalErrors = function () {
    ...
    for (ix = 0; ix <= zoneCount; ix++) {
        ...
        if (MLTolerance === Infinity) {
            ...
            combinedCorrection = userEnteredZonalCorrection - 1;
            peakValleyMLTolerance = combinedCorrection / correctionTolerance;
            ...
            if (!isNaN(userEnteredZonalCorrection)) {
                ...
                weightedMLToleranceTotal += Math.abs(combinedCorrection / correctionTolerance * zone * zone);
            }
        }
