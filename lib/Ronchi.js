...
MLB.ronchi.constants = {
    ...
    btnDrawZonalRuler: function () {
        return $('[name=btnDrawZonalRuler]');
    },
    drawZonalRuler: function () {
        return this.btnDrawZonalRuler()[this.zonal].checked;
    },
    drawUomRuler: function () {
        return this.btnDrawZonalRuler()[this.uom].checked;
    },
...
MLB.ronchi.plot = function (canvas, gratingOffset, displayErrorRonchigrams, allowableParabolicDeviation, invertBands, zoneSqrt) {
    ...
    } else if (constants.drawUomRuler()) {
        for (ix = 1; ix < mirrorDia / 2; ix += 1) {
...
MLB.ronchi.putData = function () {
    ...
    dataToSave = {
        ...
        invertBands: constants.invertBands()[constants.yes].checked,
        drawZonalRuler: constants.btnDrawZonalRuler().val()
    };
...
MLB.ronchi.getData = function () {
    ...
    switch (parsedData.drawZonalRuler) {
        case constants.noneLit:
            constants.btnDrawZonalRuler()[constants.none].checked = true;
            break;
        case constants.zonalLit:
            constants.btnDrawZonalRuler()[constants.zonal].checked = true;
            break;
        case constants.uomLit:
            constants.btnDrawZonalRuler()[constants.uom].checked = true;
            break;
        default:
            constants.btnDrawZonalRuler()[constants.none].checked = true;
    }
...
$(window).ready(function () {
    ...
    constants.btnDrawZonalRuler().change(plotRonchigrams);
