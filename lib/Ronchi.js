...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffset, userParabolicCorrection, RonchigramSize, invertBands, RonchiGrid, zonalRuler, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, distortionResolutionFactor, showBullseyeZones, thinBands
          '13':   [13.1,  80.6,  0,  65, -0.104,  1, 400, false, false, false, 0.75, 400, 400,   0,   0, MLB.base64images._13,   3, false, false],
          '13_2': [13.1,  80.6,  0,  65, -0.106,  1, 400, true,  false, false, 1.0,  400, 400,  -1,   0, MLB.base64images._13,   3, false, true],
        'grid':   [13.1,  80.6,  0,  65, -0.454,  1, 400, true,  true,  false,  0.9, 398, 402,   0,  -5, MLB.base64images._grid, 2, false, false]
    },
    images: {},
...
$(window).ready(function () {
    ...
    constants.btnPasteExampleRonchigram13_2().click(() =>   { pasteExampleRonchigram(constants.exampleImages['13_2']); });
