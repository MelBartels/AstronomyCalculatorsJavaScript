...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, RonchiGrid, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, displayUnwrappedRonchigram, unwrapY, stretchX, distortionResolutionFactor, unwrapBandRuler
        '16in':  [16.25, 93.6, 0,  65, -0.05, 1, 500, 0,  true,  false, false,  0.9, 500, 500,   1,   0, MLB.base64images._16insideRoC,  true,  false, 1, 3, true],
        '16out': [16.25, 93.6, 0,  65, 0.674, 1, 500, 0,  false, false, false,  0.9, 500, 500,   0,   0, MLB.base64images._16outsideRoC, true,  false, 2, 2, true],
        '25':    [25.1, 131,   0,  65, 0.776, 1, 400, 10, true,  false, false,  0.8, 454, 461, -16, -19, MLB.base64images._25,           false, false, 2, 2, true],
        '13':    [13.1,  80.6, 0,  65, 0.570, 1, 250, 10, true,  false, false, 0.75, 304, 320, -20, -28, MLB.base64images._13,           true,  false, 2, 2, true],
        '10in':  [10.4,  58.4, 0, 100, -0.04, 1, 250,  0, true,  false, false,  0.9, 250, 250,   0,   0, MLB.base64images._10insideRoC,  true,  false, 1, 3, true],
        '10':    [10.4,  58.4, 0, 100, 0.356, 1, 400, 10, true,  false, false,  0.9, 416, 428,   7,  -5, MLB.base64images._10,           true,  false, 2, 2, true],
...
MLB.ronchi.unwrapFirstRonchigram = function () {
    ...
    // console.log(distortionFoundCount);
...
$(window).ready(function () {
    ...
    constants.distortionResolutionFactor().change(plotRonchigrams);
