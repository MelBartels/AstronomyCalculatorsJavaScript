// copyright Mel Bartels, 2011-2022
...
MLB.ronchi.constants = {
    ...
    exampleImages: {
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY
        '16in': [16.25, 93.6, 4, 65, -0.05, 1, 500, 0, true, 0.86, 500, 500, 0, 0, '16/final Ronchigram inside RoC.jpg'],
        '16out': [16.25, 93.6, 4, 65, 0.674, 1, 500, 0, true, 0.86, 500, 500, 0, 0, '16/final Ronchigram outside RoC.jpg'],
        '25': [25.1, 131, 5.5, 65, 0.776, 1, 400, 10, true, 0.8, 454, 461, -16, -19, 'RonchiExamples/25 example.jpg'],
        '13': [13.1, 80.6, 3.1, 65, 0.570, 1, 250, 10, true, 0.75, 304, 320, -20, -28, 'RonchiExamples/13 example.jpg'],
        '10': [10.4, 58.4, 3.1, 100, 0.362, 1, 400, 10, true, 0.9, 416, 428, 7, -5, 'RonchiExamples/10 example.jpg'],
        '6': [5.9, 33.9, 2.14, 100, 0.294, 1, 400, 10, true, 0.9, 530, 496, -60, -40, 'RonchiExamples/6 example.jpg']
    },
...
MLB.ronchi.plotRonchiBands = function (mirrorDia, radiusOfCurvature, gratingFreq, gratingOffset, scalingFactor, imageData, cg, invertBands, userParabolicCorrection) {
...
MLB.ronchi.drawRonchigramOnCanvas = function (canvas, gratingOffset, invertBands, userParabolicCorrection) {
    var constants = MLB.ronchi.constants,
    ...
    plotRonchiBands(mirrorDia, radiusOfCurvature, gratingFreq, gratingOffset, scalingFactor, imageData, ronchiCenter, invertBands, userParabolicCorrection);
...
MLB.ronchi.plotRonchigrams = function () {
    ...
    for (ix = 0; ix < gratingOffsetSeriesValuesLength; ix++) {
        ...
        drawRonchigramOnCanvas($('[id=RonchiCanvas' + ix + ']')[0], gratingOffsetSeriesValues[ix], invertBands, userParabolicCorrection);
    }
