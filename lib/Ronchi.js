...
MLB.ronchi.processZonalErrors = function () {
    ...
    for (ix = 0; ix <= zoneCount; ix++) {
        ...
        if (MLTolerance === Infinity) {
            ...
            peakValleyMLTolerance = (userEnteredZonalCorrection * userParabolicCorrection - 1) / correctionTolerance;
            ...
            if (!isNaN(userEnteredZonalCorrection)) {
                ...
                weightedMLToleranceTotal += Math.abs((userEnteredZonalCorrection  * userParabolicCorrection- 1) / correctionTolerance * zone * zone);
            }
        }
