...
MLB.ronchi.getAndProcessImage = () => {
    ...
    processImage(imageData, canvasSize, RonchigramSize);

    // copy the image data back onto the canvas
    context.putImageData(imageData, 0, 0);
};

MLB.ronchi.processImage = (imageData, canvasSize, RonchigramSize) => {
    ...
    // go from left to right, for each step then go from top to bottom
    for (xIx = 0; xIx < canvasSize; xIx += 1) {
        ...
        for (yIx = 0; yIx < canvasSize; yIx += 1) {
            ...
            // we have xIx, yIx, red, green, blue ready for further processing...
            console.log('x:' + xIx + ', y:' + yIx + ', r:' + red +', g:' + green + ', b:' + blue);
        }
    }
