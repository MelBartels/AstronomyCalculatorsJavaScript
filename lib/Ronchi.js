...
MLB.ronchi.constants = {
    ...
    exampleImages: {
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, RonchiGrid, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, unwrapY, stretchX, distortionResolutionFactor, unwrapBandRuler
          '16': [16.25, 93.6,  0,  65,  -0.05,  1, 400,  0,  true, false, false,  0.9, 400, 400,   1,   0, MLB.base64images._16,   false, 1, 3,  true],
          '25': [25.1,   131,  0,  65,  0.776,  1, 400, 10,  true, false, false,  0.9, 454, 461, -16, -19, MLB.base64images._25,   true,  1, 2, false],
           '6': [ 5.9,  33.9,  0, 100,  0.294,  1, 400, 10,  true, false, false,  0.9, 530, 496, -60, -40, MLB.base64images._6,    true,  1, 2, false],
          '13': [13.1,  80.6,  0,  66, -0.104,  1, 400,  0, false, false, false, 0.75, 400, 400,   0,   0, MLB.base64images._13,   false, 1, 3, false],
        'grid': [13.1,  80.6,  0,  65, -0.454,  1, 400,  0,  true, true,  true,   0.9, 398, 402,   0,  -5, MLB.base64images._grid, true,  1, 2,  true]
    },
    images: {},
        ...
        RGDy.forEach((RGDx, xIx) => {
            /* eg, distortionRatios for default Ronchigram 12F5:
                ...
                25F2.6 outside RoC example ,distortionRatio at:
                         0,1   = 1 (distortion = 0.999995100864859; distortion varies from ~1 to ~0.2; maxDistortion = 0.999995100864859 which occurs on initial 'x'; parabola varies from 0 to 4.37883185253084, with max of 8.41948051098935 @ row of 263 out of 400)
            */
