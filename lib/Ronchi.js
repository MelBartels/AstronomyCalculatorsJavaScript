...
MLB.ronchi.constants = {
    ...
    sliderWaveErrorDecimalPrecision: 2,
    tapeBandPrecision: 2,
    ...
    sliderZonalErrorFineMouseDown: undefined,
    sliderZonalErrorCoarseMouseDown: undefined,
    images: {},
    ...
    sliderZonalErrorFine: function () {
        return $('[id=sliderZonalErrorFine]');
    },
    sliderZonalErrorCoarse: function () {
        return $('[id=sliderZonalErrorCoarse]');
    },
    canvasSize: function () {
...
MLB.ronchi.setSliderZonalErrorCoarseMinMax = function (wavesCorrection) {
    var constants = MLB.ronchi.constants;

    constants.sliderZonalErrorCoarse()[0].min = -wavesCorrection;
    constants.sliderZonalErrorCoarse()[0].max = wavesCorrection;
};
...
MLB.ronchi.plotRonchigrams = function () {
    var constants = MLB.ronchi.constants,
        ...
        setSliderZonalErrorCoarseMinMax = MLB.ronchi.setSliderZonalErrorCoarseMinMax,
        mirrorDia,
        radiusOfCurvature,
        focalRatio,
        invertBands,
    ...
    setSliderZonalErrorCoarseMinMax(wavesCorrection);
...
MLB.ronchi.updateZonalError = function () {
    ...
    // continue only if mouse down on a slider
    if (!constants.sliderZonalErrorFineMouseDown && !constants.sliderZonalErrorCoarseMouseDown) {
        return;
    }

    constants.wavefrontDeviation().val(roundToDecimal(+constants.sliderZonalErrorFine().val() + +constants.sliderZonalErrorCoarse().val(), constants.sliderWaveErrorDecimalPrecision));
    plotRonchigrams();
};
...
$(window).ready(function () {
    ...
    constants.sliderZonalErrorFine().mousemove(updateZonalError);
    constants.sliderZonalErrorFine().mousedown(function () { MLB.ronchi.constants.sliderZonalErrorFineMouseDown = true; });
    constants.sliderZonalErrorFine().mouseup(function () { MLB.ronchi.constants.sliderZonalErrorFineMouseDown = false; });
    constants.sliderZonalErrorCoarse().mousemove(updateZonalError);
    constants.sliderZonalErrorCoarse().mousedown(function () { MLB.ronchi.constants.sliderZonalErrorCoarseMouseDown = true; });
    constants.sliderZonalErrorCoarse().mouseup(function () { MLB.ronchi.constants.sliderZonalErrorCoarseMouseDown = false; });
