...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffset, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiGrid, zonalRuler, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, distortionResolutionFactor, showBullseyeZones, thinBands
          '13': [13.1,  80.6,  0,  65, -0.104,  1, 400,  0, false, false, false, 0.75, 400, 400,   0,   0, MLB.base64images._13,   3, false, false],
          '16': [16.25, 93.6,  0,  65,  -0.05,  1, 400,  0, true,  false, false,  0.9, 400, 400,   1,   0, MLB.base64images._16,   3, false, false],
          '25': [25.1,   131,  0,  65,  0.776,  1, 400, 10, true,  false, false,  0.9, 454, 461, -16, -19, MLB.base64images._25,   2, false, false],
        'grid': [13.1,  80.6,  0,  65, -0.454,  1, 400,  0, true,  true,  false,  0.9, 398, 402,   0,  -5, MLB.base64images._grid, 2, false, false]
    },
    images: {},
...
MLB.ronchi.godProcess = function () {
    ...
    if (constants.thinBands()[constants.yes].checked) {
        MLB.ronchi.prepForProcessingNulledImage();
...
MLB.ronchi.processNulledImage = (imageData, newImageData, canvasSize, RonchigramSize) => {
    ...
    // remove black noise pixel when surrounded by white pixels...
