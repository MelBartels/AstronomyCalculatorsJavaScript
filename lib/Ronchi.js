...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffset, userParabolicCorrection, RonchigramSize, invertBands, RonchiGrid, zonalRuler, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, distortionResolutionFactor, showBullseyeZones, thinBands
        ...
        'twelveF5Under':  [12,     120,   3, 100,   -0.2,  1, 400, false, false, false, 0.85, 400, 400,   0,   0, MLB.base64images._12F5, 2, false, false],
        'twelveF5Under2': [12,     120,   3, 100,   -0.2,  1, 400, false, false, false,    1, 400, 400,   0,   0, MLB.base64images._12F5, 2, false, true]
    },
    images: {},
    // ...images
...
MLB.ronchi.processZonalErrors = function () {
    ...
    for (ix = 0; ix <= zoneCount; ix++) {
        ...
        /* zonal correctionTolerance for the opening scenario:
            ...
            0.2862933333333333
            0.16567901234567903
            0.10433430515063172 <= 0.7 zone: if user sets correction to 1.15, then the reading of 1.15 exceeds the 0.104... and the computed ML value is at 144%
            0.0698958333333333
    ...
    peakValleyMLTolerance = greatestPositivePeakValleyMLTolerance - greatestNegativePeakValleyMLTolerance;
    weightedMLTolerance = weightedMLToleranceTotal / weightedMLToleranceCount;
