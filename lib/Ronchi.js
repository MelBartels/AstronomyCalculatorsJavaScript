...
MLB.ronchi.processZonalErrors = function () {
    ...
    for (ix = 0; ix <= zoneCount; ix++) {
        ...
        calcWaveErrorForZone(+zone, userParabolicCorrection, userEnteredZonalCorrection, wavelengthLight, offsetRoC, waveErrors);
    }
...
MLB.ronchi.calcWaveErrorForZone = function (zone, userParabolicCorrection, userEnteredZonalCorrection, wavelengthLight, offsetRoC, waveErrors) {
    var constants = MLB.ronchi.constants,
        mirrorDia = constants.UIMirrorDia,
        radiusOfCurvature = constants.UIRadiusOfCurvature,
        calcSphereParabolaDifference = MLB.calcLib.calcSphereParabolaDifference,
