...
MLB.ronchi.constants = {
    ...
    exampleImages: {
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, RonchiGrid, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, displayUnwrappedRonchigram
        '16in':  [16.25, 93.6, 0,  65, -0.05, 1, 500, 0,  true, false, false, 0.86, 500, 500,   1,   0, MLB.base64images._16insideRoC,  true],
        '16out': [16.25, 93.6, 0,  65, 0.674, 1, 500, 0,  true, false, false, 0.86, 500, 500,   0,   0, MLB.base64images._16outsideRoC, false],
        '25':    [25.1, 131,   0,  65, 0.776, 1, 400, 10, true, false, false, 0.8,  454, 461, -16, -19, MLB.base64images._25,           false],
        '13':    [13.1,  80.6, 0,  65, 0.570, 1, 250, 10, true, false, false, 0.75, 304, 320, -20, -28, MLB.base64images._13,           false],
        '10':    [10.4,  58.4, 0, 100, 0.356, 1, 400, 10, true, false, false, 0.9,  416, 428,   7,  -5, MLB.base64images._10,           false],
        '6':     [5.9,   33.9, 0, 100, 0.294, 1, 400, 10, true, false, false, 0.9,  530, 496, -60, -40, MLB.base64images._6,            false]
    },
    images: {},
...
MLB.ronchi.unwrapFirstRonchigram = function () {
    ...
    for (yIx = 0; yIx < RGD.length; yIx++) {
        for (xIx = 0; xIx < RGD[yIx].length; xIx++) {
            ...
            // distortionOffsetY = yIx; // ignore unwrapping y axis
            distortionOffsetX = int(xIx * distortion / maxDistortion);
