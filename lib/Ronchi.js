...
MLB.ronchi.constants = {
    ...
    // mirrorDia, radiusOfCurvature, centralObstruction, gratingFreq, gratingOffsetSeries, userParabolicCorrection, RonchigramSize, borderSize, invertBands, RonchiTape, RonchiGrid, pastedImageTransparency, pastedImageWidth, pastedImageHeight, pastedImageOffsetX, pastedImageOffsetY, imageSource, displayUnwrappedRonchigram, unwrapY, stretchX
        '16in':  [16.25, 93.6, 0,  65, -0.05, 1, 500, 0,  true, false, false, 0.86, 500, 500,   1,   0, MLB.base64images._16insideRoC,  true,  false, 1],
        '16out': [16.25, 93.6, 0,  65, 0.674, 1, 500, 0,  true, false, false, 0.86, 500, 500,   0,   0, MLB.base64images._16outsideRoC, true,  false, 2],
        '25':    [25.1, 131,   0,  65, 0.776, 1, 400, 10, true, false, false, 0.8,  454, 461, -16, -19, MLB.base64images._25,           false, false, 2],
        '13':    [13.1,  80.6, 0,  65, 0.570, 1, 250, 10, true, false, false, 0.75, 304, 320, -20, -28, MLB.base64images._13,           true,  false, 2],
        '10in':  [10.4,  58.4, 0, 100, -0.04, 1, 250,  0, true, false, false, 0.9,  250, 250,   0,   0, MLB.base64images._10insideRoC,  true,  false, 1],
        '10':    [10.4,  58.4, 0, 100, 0.356, 1, 400, 10, true, false, false, 0.9,  416, 428,   7,  -5, MLB.base64images._10,           true,  false, 2],
        '6':     [5.9,   33.9, 0, 100, 0.294, 1, 400, 10, true, false, false, 0.9,  530, 496, -60, -40, MLB.base64images._6,            true,  false, 2]
    },
    images: {},
...
MLB.ronchi.unwrapFirstRonchigram = function () {
    ...
    // apply the distortion quadrant to each original Ronchigram quadrant, filling in gaps;
    // while we have the x,y distortion, get the original corresponding pixels from each quadrant and apply the distortion to get the new distorted Ronchigram;
    // get x,y pixel starting from originating Ronchigram center, working outward horizontally and vertically, +-x,+-y for each quadrant as needed;
    ...
    for (yIx = 0; yIx < RGD.length; yIx++) {
        for (xIx = 0; xIx < RGD[yIx].length; xIx++) {
            distortion = RGD[yIx][xIx].distortion;
            ...
            /* eg, distortionRatios for default Ronchigram (no Y axis unwrap):
                yIx,xIx: 0,0   = NaN
                   ...
                   distortionRatio for 16F2.9 example (no Y axis unwrap):
                         0,1   = 0.126
            steps determined empirically: balance between zigzags and filling in skipped pixels; distortionRatio varies from 0 to 1 as xIx varies from 0 to max
            */
            ...
            xDir = 1;
            yDir = -1;
            unwrapSetPixel(yIx, xIx, yDir, xDir, ySteps, xSteps, distortionOffsetY, distortionOffsetX, canvasSize, ronchiCenter, unwrapRonchiCenter, unwrapImageData, origImg);
...
MLB.ronchi.unwrapSetPixel = function (yIx, xIx, yDir, xDir, ySteps, xSteps, distortionOffsetY, distortionOffsetX, canvasSize, ronchiCenter, unwrapRonchiCenter, unwrapImageData, origImg) {
    var setPixel = MLB.sharedLib.setPixel,
        originalY = ronchiCenter.y + yIx * yDir,
        originalX = ronchiCenter.x + xIx * xDir,
        OIx = (originalY * canvasSize + originalX) * 4,
