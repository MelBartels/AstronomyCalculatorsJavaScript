...
MLB.pitchLapCalc.getPolishingActionForAllToolNodes = function () {
    var common = MLB.pitchLapCalc.common,
        yOffset,
        getStrokeLengthAndOffsetInXY = MLB.pitchLapCalc.getStrokeLengthAndOffsetInXY,
        strokeAndOffsetInXY,
        mirrorNodes = common.mirrorNodes,
        getPolishingActionForAToolNode = MLB.pitchLapCalc.getPolishingActionForAToolNode;
    ...
    for (yOffset = 0; yOffset <= strokeAndOffsetInXY.yStroke; yOffset += 1) {
        ...
        mirrorNodes.forEach(function (xMirrorNode) {
            xMirrorNode.yNodes.forEach(function (mirrorNode) {
                ...
                getPolishingActionForAToolNode(strokeAndOffsetInXY.xOffset, yOffset, mirrorNode);
            });
        });
    }
};

MLB.pitchLapCalc.getPolishingActionForAToolNode = function (xOffset, yOffset, mirrorNode) {
    var common = MLB.pitchLapCalc.common,
        xTool,
        yTool,
...
MLB.pitchLapCalc.calculatePitchLapAndAction = function () {
    var common = MLB.pitchLapCalc.common,
        ...
        getPolishingActionForAllToolNodes = MLB.pitchLapCalc.getPolishingActionForAllToolNodes,
    ...
    createMirrorNodes();
    createToolNodes();
    getPolishingActionForAllToolNodes();
