// copyright Mel Bartels, 2017-2023
...
MLB.pitchLapCalc.common = {
    ...
    netRotationResults: function () {
        return $('[id=netRotationResults]');
    },
...
// for stroke, offset in one direction (not counting the return stroke length), 10 inch mirror with 0.2 stroke means 0.1 stroke up, then 0.2 stroke down, then 0.1 stroke up, returning to the starting position;
...
MLB.pitchLapCalc.calcSpinningTOT = function () {
    var common = MLB.pitchLapCalc.common,
        ...
        yOffset = +common.spinOffset().val() * common.mirrorXYSize,
    ...
    common.netRotationResults().text('Net direction (positive is CW, negative is CCW) = ' + Math.floor(rotationalVectorResults.totalNetDirection + 0.5));
...
$(document).ready(function () {
    ...
    common.spinToolRotation().change(calcSpinningTOT);
