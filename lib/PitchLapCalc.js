...
MLB.pitchLapCalc.populateSpinRotationalVectorCanvas = (rotationalVectorResults) => {
    ...
    // draw in tool
    fillCircle(context, toolCenter, radiusScaled * rotationalVectorResults.toolToMirrorSizeRatio, 'black');
    ...
    drawCircle(context, toolCenter, radiusScaled * rotationalVectorResults.toolToMirrorSizeRatio, 'black');
