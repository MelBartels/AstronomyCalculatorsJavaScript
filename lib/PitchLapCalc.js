// copyright Mel Bartels, 2017-2025
...
MLB.pitchLapCalc.common = {
    ...
    // graph size of 400 divided into calculated steps of 200 with 2 pixel smoothing
    mirrorXYSize: 200,
    smoothingValues: 2,
    ...
    spinMirrorRotation: function () {
        return $('[id=spinMirrorRotation]');
    },
    ...
    freeToolRotationRate: function () {
        return $('[id=freeToolRotationRate]');
    },
...
MLB.pitchLapCalc.createToolNodes = function (toolXYSize) {
    var common = MLB.pitchLapCalc.common,
...
MLB.pitchLapCalc.smoothWeightedMirrorPolishingActions = function (weightedPolishingActions) {
    var common = MLB.pitchLapCalc.common,
...
MLB.pitchLapCalc.sortZones = function () {
    var common = MLB.pitchLapCalc.common,
...
MLB.pitchLapCalc.displayPolishingActionsSideView = function (polishActions, canvas) {
    var common = MLB.pitchLapCalc.common,
        xySize = common.mirrorXYSize,
        context = canvas.getContext('2d'),
        topRightPoint,
...
MLB.pitchLapCalc.displayPolishingActionsTopView = function (polishActions, canvas) {
    var common = MLB.pitchLapCalc.common,
        context = canvas.getContext('2d'),
        center,
        strokeStyle,
...
MLB.pitchLapCalc.drawImageOnCanvas = function () {
    var common = MLB.pitchLapCalc.common,
        canvas = common.pitchLapCanvas(),
        context = canvas.getContext("2d"),
        transparency = 0.75;
...
MLB.pitchLapCalc.createRotationalVectors = function (nodes, direction, modifyPerToolContact) {
    var common = MLB.pitchLapCalc.common,
        xySize = common.mirrorXYSize,
        halfXYSize = xySize / 2;
...
MLB.pitchLapCalc.getRotationalVectorForAMirrorNode = function (mirrorNode, yOffset) {
    var common = MLB.pitchLapCalc.common,
        xTool,
        yTool,
        toolNodes = common.toolNodes,
...
MLB.pitchLapCalc.calcSpinVectorsForTOT = function (toolToMirrorSizeRatio, mirrorDirection, toolDirection, yOffset) {
    var common = MLB.pitchLapCalc.common,
        createMirrorNodes = MLB.pitchLapCalc.createMirrorNodes,
        createToolNodes = MLB.pitchLapCalc.createToolNodes,
...
MLB.pitchLapCalc.populateSpinRotationalVectorCanvas = function (rotationalVectorResults) {
    var common = MLB.pitchLapCalc.common,
        mirrorNodes = common.mirrorNodes,
        xySize = common.mirrorXYSize,
    ...
    // draw in mirror
    fillCircle(context, center, radiusScaled, 'lightgray');
    // draw in tool
    fillCircle(context, new point(center.x, center.y - rotationalVectorResults.yOffset * scalingFactor), radiusScaled * rotationalVectorResults.toolToMirrorSizeRatio, 'black');
    ...
    mirrorNodes.forEach(xMirrorNode => {
        xMirrorNode.yNodes.forEach(mirrorNode => {
            ...
            if (mirrorNode.toolNode) {
                ...
                nodePoint = new point(center.x + xScaled, center.y + yScaled);
...
MLB.pitchLapCalc.calcSpinWeightedMirrorPolishingActions = function () {
    var common = MLB.pitchLapCalc.common;
...
MLB.pitchLapCalc.calcSpinningTOT = function () {
    var common = MLB.pitchLapCalc.common,
        toolToMirrorSizeRatio = +common.spinToolToMirrorSizeRatio().val(),
        mirrorDirection = +common.spinMirrorRotation().val(),
	...
	// redo using best result
    common.mirrorSpinPolishingActionPerRadius = [];
    common.mirrorSpinPolishingActionPerRadiusWeighted = [];
	rotationalVectorResults = calcSpinVectorsForTOT(toolToMirrorSizeRatio, mirrorDirection, bestToolDirection, yOffset);
	populateSpinRotationalVectorCanvas(rotationalVectorResults);

    common.freeToolRotationRate().text('Tool free rotation rate is ' + roundToDecimal(bestToolDirection, 3));
...
MLB.pitchLapCalc.calcSpinningTOTWithUserDefinedToolRotation = function () {
    var common = MLB.pitchLapCalc.common,
        toolToMirrorSizeRatio = +common.spinToolToMirrorSizeRatio().val(),
        mirrorDirection = +common.spinMirrorRotation().val(),
        toolDirection = +common.spinToolRotation().val(),//note todo
        yOffset = +common.spinOffset().val() * common.mirrorXYSize / 2,
        calcSpinVectorsForTOT = MLB.pitchLapCalc.calcSpinVectorsForTOT,
        populateSpinRotationalVectorCanvas = MLB.pitchLapCalc.populateSpinRotationalVectorCanvas,
        calcSpinWeightedMirrorPolishingActions = MLB.pitchLapCalc.calcSpinWeightedMirrorPolishingActions,
    ...
    common.mirrorSpinPolishingActionPerRadius = [];
    common.mirrorSpinPolishingActionPerRadiusWeighted = [];
	populateSpinRotationalVectorCanvas(calcSpinVectorsForTOT(toolToMirrorSizeRatio, mirrorDirection, toolDirection, yOffset));
    calcSpinWeightedMirrorPolishingActions();
    common.mirrorSpinPolishingActionPerRadiusWeighted = smoothWeightedMirrorPolishingActions(common.mirrorSpinPolishingActionPerRadiusWeighted);
    displayPolishingActionsSideView(common.mirrorSpinPolishingActionPerRadiusWeighted, common.spinPolishingActionSideViewCanvas());
    displayPolishingActionsTopView(common.mirrorSpinPolishingActionPerRadiusWeighted, common.spinPolishingActionTopViewCanvas());
...
$(document).ready(function () {
    ...
    common.spinMirrorRotation().change(calcSpinningTOT);
