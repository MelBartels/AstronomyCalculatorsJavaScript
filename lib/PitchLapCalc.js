...
MLB.pitchLapCalc.common = {
	...
	btnFanPatternExample: function () {
		return $('[id=btnFanPatternExample]');
	},
...
MLB.pitchLapCalc.calcSpinningTOT = () => {
	...
	// friction of '0' means no friction from the user's perspective, but no friction from the equation's perspective means '1'
	bestToolDirectionAdjustedForFriction = bestToolDirection / (friction + 1);
...
MLB.pitchLapCalc.calcToolOffset = () => {
	...
	common.toolOverhangLabel().html('tool overhang = ' + roundToDecimal(toolOverhangPerToolDiameter * 100, 0) + '% of tool dia');
};

MLB.pitchLapCalc.setupFanPatternedLap = () => {
    var common = MLB.pitchLapCalc.common,
		calculateAndDisplayPolishingAction = MLB.pitchLapCalc.calculateAndDisplayPolishingAction,
		calcSpinningTOT = MLB.pitchLapCalc.calcSpinningTOT;

	$(common.zoneIdLit + '1]').val('0.0');
	$(common.zoneContactIdLit + '1]').val('1');
	$(common.zoneIdLit + '2]').val('0.2');
	$(common.zoneContactIdLit + '2]').val('0.95');
	$(common.zoneIdLit + '3]').val('0.4');
	$(common.zoneContactIdLit + '3]').val('0.9');
	$(common.zoneIdLit + '4]').val('0.6');
	$(common.zoneContactIdLit + '4]').val('0.85');
	$(common.zoneIdLit + '5]').val('0.8');
	$(common.zoneContactIdLit + '5]').val('0.8');
	$(common.zoneIdLit + '6]').val('1.0');
	$(common.zoneContactIdLit + '6]').val('0.7');
	$(common.zoneIdLit + '7]').val('');
	$(common.zoneIdLit + '8]').val('');
	$(common.zoneIdLit + '9]').val('');
	$(common.zoneIdLit + '10]').val('');

	common.chBoxUsePitchLapContact()[0].checked = true;
	common.friction().val(3.25);
...
$(document).ready(() => {
    var common = MLB.pitchLapCalc.common,
		...
		setupFanPatternedLap = MLB.pitchLapCalc.setupFanPatternedLap;
	...
	common.btnFanPatternExample().click(setupFanPatternedLap);
