...
MLB.pitchLapCalc.populateSpinCanvas = function (rotationalVectorResults) {
    var common = MLB.pitchLapCalc.common,
        mirrorNodes = common.mirrorNodes,
        xySize = common.mirrorXYSize,
        canvas = common.spinCanvas(),
        context = canvas.getContext('2d'),
        point = MLB.sharedLib.point,
        fillCircle = MLB.sharedLib.fillCircle,
        minSide,
...
$(document).ready(function () {
    ...
    common.testToolToMirrorSizeRatio().change(calcSpinningTOT);
    common.testMirrorRotation().change(calcSpinningTOT);
    common.testToolRotation().change(calcSpinningTOT);
    common.testToolOffset().change(calcSpinningTOT);
