...
MLB.Altaz2StarAlignPointingErrors.updateInitStarsFromInitStarsList = function () {
	var uom = MLB.sharedLib.uom,
	    ...
	    initStarsList = document.getElementById("initStarsList"),
		xform,
		starsIx,
...
MLB.Altaz2StarAlignPointingErrors.plot = function () {
	var point = MLB.sharedLib.point,
		...
		numberTrials = document.getElementById('numberTrials').value,
		maxInitErrorDeg = document.getElementById('maxInitErrorDeg').value,
		maxPointErrorDeg = document.getElementById('maxPointErrorDeg').value,
		z1Deg = document.getElementById('z1Deg').value,
		z2Deg = document.getElementById('z2Deg').value,
...
MLB.Altaz2StarAlignPointingErrors.startInitializationLoop = function () {
	var plot = MLB.Altaz2StarAlignPointingErrors.plot,
	    numberTrials = document.getElementById('numberTrials');
...
MLB.Altaz2StarAlignPointingErrors.load = function () {
	var stars = MLB.Altaz2StarAlignPointingErrors.stars,
	    ...
	    btnStartLoop = document.getElementById('btnStartLoop'),
	    btnStopLoop = document.getElementById('btnStopLoop'),
		initStarsList = document.getElementById("initStarsList"),
		ix,
		starIx1,
		starIx2,
