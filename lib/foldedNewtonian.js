...
MLB.foldedNewtonian.getFoldedNewtonianScalingFactor = function (width, height, focalRatio, diagSize, focalPlaneToTertiaryDistance, diagToMirrorDistance) {
	var maxWidth,
	    maxHeight,
	...
	maxHeight = (diagSize * focalRatio + focalPlaneToTertiaryDistance) * 2;
...
MLB.foldedNewtonian.plot = function () {
	var canvas,
		...
		getFoldedNewtonianScalingFactor = MLB.foldedNewtonian.getFoldedNewtonianScalingFactor,
...
MLB.foldedNewtonian.load = function () {
