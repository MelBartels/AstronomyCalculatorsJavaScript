...
MLB.foldedNewtonian.plot = function () {
	...
	scalingFactor = getFoldedNewtonianScalingFactor(canvas.width, canvas.height, focalRatio, diagSize, focalPlaneToTertiaryDistance, tertiaryOffsetFromEdgeOfPrimary, model.diagToMirrorDistance);
	...
	*/
	...
	elbowEndPt = point(mirrorPt.x - scalingFactor * model.eyepieceToMirrorDistance, mirrorPt.y - scalingFactor * (mirrorDia / 2 + tertiaryOffsetFromEdgeOfPrimary));
