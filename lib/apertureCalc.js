...
MLB.apertureCalc.calcEyepieceFieldStop = function () {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		// guestimate from 50 deg eyepieces = no distortion to 80 deg eyepieces = 15% distortion
...
MLB.apertureCalc.calcFOV = function () {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		resultFOV = calcFOVFromAperture_EyepieceFL_EyepieceFieldStop_EyePupil(apertureInches, eyepieceFocalLengthmm, eyepieceFieldStopmm, exitPupilmm);
...
MLB.apertureCalc.calcAperture = function () {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		resultAperture = calcApertureFromFOV_EyepieceFL_EyepieceFieldStop_EyePupil(FOVdeg, eyepieceFocalLengthmm, eyepieceFieldStopmm, exitPupilmm);
