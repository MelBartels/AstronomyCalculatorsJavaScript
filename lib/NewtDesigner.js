...
MLB.Saguaro81AbbrJson.Saguaro81Abbr.find(rec => rec.OBJECT === 'NGC 7638') // one object

MLB.Saguaro81AbbrJson.Saguaro81Abbr.filter(rec => rec.OBJECT.match(/NGC 75/gi)) // returns array of objectSizeArcMin1

MLB.Saguaro81AbbrJson.Saguaro81Abbr.filter(rec => rec.OBJECT.match(/NGC 75/gi))[3]
{OBJECT: "NGC 7502", OTHER: "ESO 604-**5", TYPE: "1STAR", CON: "AQR", MAG: 99.9, …}
