// copyright Mel Bartels, 2016 - 2023
...
MLB.NewtDesigner.config = {
    ...
    jumpTo: {
        ...
        focalLengthPrimary: 'focalLengthPrimary',
        idealAperture: 'idealAperture',
        lowMags: 'lowMags',
        combinationScopes: 'combinationScopes',
        apertureFever: 'apertureFever',
        RFT: 'RFT',
...
MLB.NewtDesigner.calcP2Intrusion = function () {
    var state = MLB.NewtDesigner.state,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        uom = MLB.sharedLib.uom,
...
MLB.NewtDesigner.drawP2Intrusion = function (context, canvasCenter, scalingFactor) {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        state = MLB.NewtDesigner.state,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
    ...
    if (P2Intrusion.intrudes) {
        common.P2IntrusionResultsLabel().html('P2 intrusion area is '
                + roundToDecimal(P2Intrusion.intrusionArea, config.decimalPointsDimension)
                + ' '
                + common.getAreaLit()
                + '; percentage of aperture is '
                + roundToDecimal(P2Intrusion.intrusionRatio * 100, config.decimalPointsPercent)
                + '%');
    } else {
...
MLB.NewtDesigner.drawOffsetShadow = function () {
    ...
    drawP2Intrusion(context, canvasCenter, scalingFactor);
...
MLB.NewtDesigner.processURLhash = function () {
    ...
    case jumpTo.focalLengthPrimary:
    case jumpTo.idealAperture:
    case jumpTo.lowMags:
    case jumpTo.combinationScopes:
    case jumpTo.apertureFever:
    ...
    case jumpTo.selectingTelescope:
        updateSelectedThenScrollToTop(common.btnSelectingTelescope(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, hash);
        break;
    case jumpTo.telescopePerformance:
        updateSelectedThenScrollToTop(common.btnTelescopePerformance(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, hash);
        break;
    ...
    case jumpTo.telescopeValue:
        updateSelectedThenScrollToTop(common.btnBartelsEquation(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, hash);
        break;
    ...
    case jumpTo.telescopeRequirements:
        updateSelectedThenScrollToTop(common.btnTelescopeRequirements(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, hash);
        break;
    ...
    case jumpTo.visualSkyBackgroundBrightness:
        updateSelectedThenScrollToTop(common.btnSkyBackgroundBrightness(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    ...
    case jumpTo.visualHowToLookThroughEyepiece:
        updateSelectedThenScrollToTop(common.btnVisualHowToLookThroughEyepiece(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualObservingLanguage:
        updateSelectedThenScrollToTop(common.btnVisualObservingLanguage(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualPsychology:
        updateSelectedThenScrollToTop(common.btnVisualPsychology(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualMagnification:
        updateSelectedThenScrollToTop(common.btnVisualMagnification(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualWideField:
        updateSelectedThenScrollToTop(common.btnVisualWideField(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    ...
    case jumpTo.visualObservingFactors:
        updateSelectedThenScrollToTop(common.btnVisualObservingFactors(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    ...
    case jumpTo.visualTipsImproveObserving:
        updateSelectedThenScrollToTop(common.btnVisualTipsImproveObserving(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualPlanningObservations:
        updateSelectedThenScrollToTop(common.btnVisualPlanningObservations(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    case jumpTo.visualReferences:
        updateSelectedThenScrollToTop(common.btnVisualReferences(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, hash);
        break;
    // eyepieces
    ...
    case jumpTo.exitPupil:
        updateSelectedThenScrollToTop(common.btnExitPupil(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, hash);
        break;
    case jumpTo.oversizedExitPupil:
        updateSelectedThenScrollToTop(common.btnOversizedExitPupil(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, hash);
        break;
    ...
    case jumpTo.stoppingDownMatchingApertureWithEyeResolution:
        updateSelectedThenScrollToTop(common.btnStoppingDownMatchingApertureWithEyeResolution(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, hash);
        break;
    // coma corrector
    ...
    case jumpTo.twoUnknownOptimizations:
        updateSelectedThenScrollToTop(common.btnTwoUnknownOptimizations(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, hash);
        break;
