...
MLB.NewtDesigner.config = {
    version: 'Last updated 16-June-2020',
...
MLB.NewtDesigner.calcDiag = function () {
    ...
    diagSize = diag.smallestUserDefinedSize;
    ...
    diag.smallestUserDefinedSize = diag.suitableDiags[0];
    diag.minSize = minSize;
    diag.maxIllumSize = maxIllumDiag;
    diag.evenIllumSize = diag.suitableDiags[suitableDiagsLength - 1];
