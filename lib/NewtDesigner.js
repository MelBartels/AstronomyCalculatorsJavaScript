...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
	...
	} else if (parsedData.eyepieceList === undefined && eyepieceDefined) {
		common.btnEyepieceList()[0].checked = true;
	}
	// after setting btnEyepieceList() now fill eyepiece row selection column with correct eyepiece data
