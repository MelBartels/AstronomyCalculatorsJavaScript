...
MLB.NewtDesigner.calcBinoscopeMinimumFocalPlaneToSecondaryDistance = function () {
    var common = MLB.NewtDesigner.common,
        uom = MLB.sharedLib.uom,
        ...
        secondaryToTiertiaryPerpendicularDistance,
        shortenedDistanceDueToTertiaryBendingAngle,
        ...
        if (useSecondaryBendingAngle()) {
            ...
            secondaryToTiertiaryPerpendicularDistance = (aperture / 2 + focalPointPerpendicularOffsetFromEdgeOfPrimary) / Math.cos((90 - secondaryBendingAngleDeg) * uom.degToRad);
        } else {
            secondaryToTiertiaryPerpendicularDistance = aperture / 2 + focalPointPerpendicularOffsetFromEdgeOfPrimary;
        }
        shortenedDistanceDueToTertiaryBendingAngle = Math.sin(tertiaryBendingAngleDeg * uom.degToRad) * focalPlaneToTertiaryDistance;
        minimumFocalPlaneToSecondaryDistance = secondaryToTiertiaryPerpendicularDistance + focalPlaneToTertiaryDistance - shortenedDistanceDueToTertiaryBendingAngle;

    return minimumFocalPlaneToSecondaryDistance;
};

MLB.NewtDesigner.setBinoscopeFocalPlaneToSecondaryDistanceToMinimum = function () {
    var common = MLB.NewtDesigner.common,
        uom = MLB.sharedLib.uom,
        constantToAccountForMathRoundingIssues = 0.000000001, //note todo
        binoscopeTertiaryBendingAngleDeg = common.binoscopeTertiaryBendingAngleDegVal(),
        focalPlaneToTertiaryDistance = common.binoscopeFocalPlaneToTertiaryDistanceVal(),
        calcBinoscopeMinimumFocalPlaneToSecondaryDistance = MLB.NewtDesigner.calcBinoscopeMinimumFocalPlaneToSecondaryDistance,
        minimumFocalPlaneToSecondaryDistance = calcBinoscopeMinimumFocalPlaneToSecondaryDistance(),
        shortenedDistanceDueToTertiaryBendingAngle = Math.sin(binoscopeTertiaryBendingAngleDeg * uom.degToRad) * focalPlaneToTertiaryDistance,
        focalPlaneToSecondaryDistance = minimumFocalPlaneToSecondaryDistance - shortenedDistanceDueToTertiaryBendingAngle;

    common.binoscopeFocalPlaneToSecondaryDistance().val(focalPlaneToSecondaryDistance + constantToAccountForMathRoundingIssues);
};

MLB.NewtDesigner.binoscopeWorkflow = function () {
    var useSecondaryBendingAngle = MLB.NewtDesigner.useSecondaryBendingAngle,
...
$(window).ready(function () {
    ...
    common.binoscopeFocalPlaneToSecondaryDistance().change(function (e) {
        var calcBinoscopeMinimumFocalPlaneToSecondaryDistance = MLB.NewtDesigner.calcBinoscopeMinimumFocalPlaneToSecondaryDistance,
             min = calcBinoscopeMinimumFocalPlaneToSecondaryDistance();

        if (e.currentTarget.value < min) {
            alert('Binoscope focal plane to secondary distance needs to be at least ' + min);
            return;
        }
        binoscopeWorkflow();
    });
