...
MLB.NewtDesigner.common = {
    ...
    binoscopeChBoxLockSecondaryBendingAngle: function () {
        return $('[id=binoscopeChBoxLockSecondaryBendingAngle]');
    },
    binoscopeChBoxLockSecondaryBendingAngleChecked: function () {
        return this.binoscopeChBoxLockSecondaryBendingAngle().is(':checked');
    },
    ...
    binoscopeChBoxLockTertiaryBendingAngle: function () {
        return $('[id=binoscopeChBoxLockTertiaryBendingAngle]');
    },
    binoscopeChBoxLockTertiaryBendingAngleChecked: function () {
        return this.binoscopeChBoxLockTertiaryBendingAngle().is(':checked');
    },
...
MLB.NewtDesigner.useSecondaryBendingAngle = function () {
    ...
    return common.binoscopeChBoxLockSecondaryBendingAngleChecked() && !isNaN(common.binoscopeSecondaryBendingAngleDegVal()) && common.binoscopeSecondaryBendingAngleDegVal() > 0;
};

MLB.NewtDesigner.useTertiaryBendingAngle = function () {
    var common = MLB.NewtDesigner.common;

    return common.binoscopeChBoxLockTertiaryBendingAngleChecked() && !isNaN(common.binoscopeTertiaryBendingAngleDegVal());
};

MLB.NewtDesigner.attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle = function () {
    var common = MLB.NewtDesigner.common,
...
*/
MLB.NewtDesigner.attemptToUpdateBinoscopeBasedOnTertiaryBendingAngle = function () {
    var common = MLB.NewtDesigner.common,
        useTertiaryBendingAngle = MLB.NewtDesigner.useTertiaryBendingAngle,
        graphBinoscope = MLB.NewtDesigner.graphBinoscope,
        graphBinoscopeFrontView = MLB.NewtDesigner.graphBinoscopeFrontView;

    if (useTertiaryBendingAngle()) {
        alert('feature not ready: coding in progress');
        //mlb note todo
        //graphBinoscope();
        //graphBinoscopeFrontView();
    }
...
MLB.NewtDesigner.updateBinoscopeFocalPlaneToSecondaryDistanceBasedOnSecondaryBendingAngle = function () {
    ...
    common.binoscopeFocalPlaneToSecondaryDistance().val(roundToDecimal(focalPlaneToSecondaryDistance, config.decimalPointsDimension));
};
...
MLB.NewtDesigner.updateBinoscopeFocalPlaneToSecondaryDistance = function () {
    ...
    // can also just call the function, ie, common.binoscopeFocalPlaneToSecondaryDistance().val(calcBinoscopeFocalPlaneToSecondaryDistance);
...
$(window).ready(function () {
    var state = MLB.NewtDesigner.state,
        ...
        graphFlexRocker = MLB.NewtDesigner.graphFlexRocker,
        graphEquatorialTable = MLB.NewtDesigner.graphEquatorialTable,
        attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle = MLB.NewtDesigner.attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle,
    ...
    // cannot have attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle() returning true/false because it will set the check box
    common.binoscopeChBoxLockSecondaryBendingAngle().click(attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle);
    common.binoscopeSecondaryBendingAngleDeg().change(attemptToUpdateBinoscopeBasedOnSecondaryBendingAngle);
    common.binoscopeChBoxLockTertiaryBendingAngle().click(attemptToUpdateBinoscopeBasedOnTertiaryBendingAngle);
    common.binoscopeTertiaryBendingAngleDeg().change(attemptToUpdateBinoscopeBasedOnTertiaryBendingAngle);
