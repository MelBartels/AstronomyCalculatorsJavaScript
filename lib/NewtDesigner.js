// copyright Mel Bartels, 2016 - 2022
...
MLB.NewtDesigner.config = {
    ...
    jumpTo: {
        ...
        // telescope designer
        telescope: 'telescope',
        focalLengthApertureFocalRatio: 'focalLengthApertureFocalRatio',
        comparingAperture: 'comparingAperture',
        apertureManagement: 'apertureManagement',
        apertureEyepieceFOV: 'apertureEyepieceFOV',
        ...
        selectingTelescope: 'selectingTelescope',
        RFT: 'RFT',
        etendue: 'etendue',
        HET: 'HET',
        HETrealWorldComparison: 'HETrealWorldComparison',
        designingWithEtendue: 'designingWithEtendue',
        designByExitPupil: 'designByExitPupil',
        designByTrueField: 'designByTrueField',
        comboScopes: 'comboScopes',
        ...
        visualSkyBackgroundBrightness: 'visualSkyBackgroundBrightness',
        visualObjectBrightness: 'visualObjectBrightness',
        visualHowFaint: 'visualHowFaint',
        visualObjectTypes: 'visualObjectTypes',
        visualHowToLookThroughEyepiece: 'visualHowToLookThroughEyepiece',
        visualObservingLanguage: 'visualObservingLanguage',
        visualPsychology: 'visualPsychology',
        visualMagnification: 'visualMagnification',
        visualWideField: 'visualWideField',
        visualBinoscopes: 'visualBinoscopes',
        visualObservingFactors: 'visualObservingFactors',
        visualNightVisionDevices: 'visualNightVisionDevices',
        visualTipsImproveObserving: 'visualTipsImproveObserving',
        visualPlanningObservations: 'visualPlanningObservations',
        visualReferences: 'visualReferences',
        // eyepieces
        eyepieces: 'eyepieces',
        exitPupil: 'exitPupil',
        oversizedExitPupil: 'oversizedExitPupil',
        magnification: 'magnification',
        stoppingDownMatchingApertureWithEyeResolution: 'stoppingDownMatchingApertureWithEyeResolution',
        // coma corrector
    ...
    */
    ...
    diagOffsetAlongFacetLabelLit: 'Diagonal offset (along diagonal face)',
...
MLB.NewtDesigner.common = {
    ...
    // telescope designer
    btnFocalLengthApertureFocalRatio: function () {
        return $('[id=btnFocalLengthApertureFocalRatio]')[0];
    },
    btnComparingAperture: function () {
        return $('[id=btnComparingAperture]')[0];
    },
    btnApertureManagement: function () {
        return $('[id=btnApertureManagement]')[0];
    },
    btnApertureEyepieceFOV: function () {
        return $('[id=btnApertureEyepieceFOV]')[0];
    },
    btnResolution: function () {
        return $('[id=btnResolution]')[0];
    },
    ...
    btnBartelsEquation: function () {
        return $('[id=btnBartelsEquation]')[0];
    },
    btnTelescopePerformance: function () {
        return $('[id=btnTelescopePerformance]')[0];
    },
    ...
    btnSelectingTelescope: function () {
        return $('[id=btnSelectingTelescope]')[0];
    },
    btnRFT: function () {
        return $('[id=btnRFT]')[0];
    },
    btnEtendue: function () {
        return $('[id=btnEtendue]')[0];
    },
    btnHET: function () {
        return $('[id=btnHET]')[0];
    },
    btnHETrealWorldComparison: function () {
        return $('[id=btnHETrealWorldComparison]')[0];
    },
    btnDesigningWithEtendue: function () {
        return $('[id=btnDesigningWithEtendue]')[0];
    },
    btnDesignByExitPupil: function () {
        return $('[id=btnDesignByExitPupil]')[0];
    },
    btnDesignByTrueField: function () {
        return $('[id=btnDesignByTrueField]')[0];
    },
    btnComboScopes: function () {
        return $('[id=btnComboScopes]')[0];
    },
    ...
    btnVisualSkyBackgroundBrightness: function () {
        return $('[id=btnVisualSkyBackgroundBrightness]')[0];
    },
    ...
    btnVisualHowToLookThroughEyepiece: function () {
        return $('[id=btnVisualHowToLookThroughEyepiece]')[0];
    },
    btnVisualObservingLanguage: function () {
        return $('[id=btnVisualObservingLanguage]')[0];
    },
    btnVisualPsychology: function () {
        return $('[id=btnVisualPsychology]')[0];
    },
    btnVisualMagnification: function () {
        return $('[id=btnVisualMagnification]')[0];
    },
    btnVisualWideField: function () {
        return $('[id=btnVisualWideField]')[0];
    },
    btnVisualBinoscopes: function () {
        return $('[id=btnVisualBinoscopes]')[0];
    },
    btnVisualObservingFactors: function () {
        return $('[id=btnVisualObservingFactors]')[0];
    },
    btnVisualNightVisionDevices: function () {
        return $('[id=btnVisualNightVisionDevices]')[0];
    },
    btnVisualTipsImproveObserving: function () {
        return $('[id=btnVisualTipsImproveObserving]')[0];
    },
    btnVisualPlanningObservations: function () {
        return $('[id=btnVisualPlanningObservations]')[0];
    },
    btnVisualReferences: function () {
        return $('[id=btnVisualReferences]')[0];
    },
    // eyepieces
    btnExitPupil: function () {
        return $('[id=btnExitPupil]')[0];
    },
    btnOversizedExitPupil: function () {
        return $('[id=btnOversizedExitPupil]')[0];
    },
    btnMagnification: function () {
        return $('[id=btnMagnification]')[0];
    },
    btnStoppingDownMatchingApertureWithEyeResolution: function () {
        return $('[id=btnStoppingDownMatchingApertureWithEyeResolution]')[0];
    },
    // coma corrector
    // diagonal
...
MLB.NewtDesigner.calcFRMaxEtendueFR = function () {
...
MLB.NewtDesigner.calcFRMaxEtendueEtendue = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        eyePupilmm = common.calcFRMaxEtendueEyePupilmmVal(),
...
MLB.NewtDesigner.calcVisualDetection = function () {
    ...
    // and now jump to plotting the results against a range of apertures and Bortle levels
...
MLB.NewtDesigner.plotRangeOfVisualDetections = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        calcContrastOfObjectPlusSkyToSky = MLB.calcLib.calcContrastOfObjectPlusSkyToSky,
...
MLB.NewtDesigner.plotApparentSizeVsMagnification = function () {
    var common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.calcTotalMagnitude = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.updateFocalPlaneToDiagDistanceFromFocuserDesigner = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.calcVignettedIllumPercent = function (diagSize) {
    var common = MLB.NewtDesigner.common,
        ...
        diagIllumArray = getDiagIllumArray(aperture, focalLength, diagSize, focalPlaneToDiagDistance, offAxisIncrement, maxFieldDia),
...
MLB.NewtDesigner.graphDiagIllum = function () {
    ...
    for (ix = 0; ix < suitableDiagsLength; ix += 1) {
        calcs.push(getDiagIllumArray(aperture, focalLength, diag.suitableDiags[ix], focalPlaneToDiagDistance, offAxisIncrement, maxFieldDia));
    ...
    */
    ...
    suitableDiagsLength = diag.suitableDiags.length;
    for (diagIx = 0; diagIx < suitableDiagsLength; diagIx += 1) {
        seriesLabels.push(seriesLabel(diag.suitableDiags[diagIx] + uomLengthLit + ' minor axis diagonal'));
    }
    ...
    $.jqplot(common.diagIntegratedIllumChartID(), [series], {
        ...
        axes: {
            xaxis: {
                renderer: $.jqplot.CategoryAxisRenderer,
                tickRenderer: $.jqplot.CanvasAxisTickRenderer,
                label: 'diagonal minor axis size',
                labelRenderer: $.jqplot.CanvasAxisLabelRenderer,
...
MLB.NewtDesigner.writeDiagResults = function () {
    ...
    diag.suitableDiags.map(function (diag, ix) {
        equivalentApertureStr += diag
                + ': '
    ...
    common.diagResults().html('Smallest possible diagonal  = '
            ...
            + integratedVignettedIllumsStr
            + '<br>Equivalent aperture ranges from edge of field to center of field for each diagonal size:<br>&nbsp&nbsp&nbsp&nbsp'
            + equivalentApertureStr
            ...
            + uomLengthLit
            + '<br>'
            + config.diagOffsetAlongFacetLabelLit
            + ' = '
...
MLB.NewtDesigner.drawOffsetShadow = function () {
    var state = MLB.NewtDesigner.state,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
    ...
    context.fillText(config.diagOffsetShadowLegendLit, config.canvasDimensionHalfHeight * 2, config.canvasDimensionHeight);
};

MLB.NewtDesigner.drawOffsetInFocuser = function () {
    var state = MLB.NewtDesigner.state,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        drawCanvasOutline = MLB.NewtDesigner.drawCanvasOutline,
...
MLB.NewtDesigner.useSecondaryBendingAngle = function () {
    var common = MLB.NewtDesigner.common;
...
MLB.NewtDesigner.getBinoscopeMinimumFocalPlaneToSecondaryDistance = function () {
    var common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.setBinoscopeFocalPlaneToSecondaryDistanceToMinimum = function () {
    var common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.setBinoscopeTertiaryBendingAngleFromEyepieceDivergence = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.setBinoscopeEyepieceDivergenceFromTertiaryBendingAngle = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.setBinoscopeSecondaryBendingAngleToFormRightAngleWithTertiaryAngle = function () {
    var common = MLB.NewtDesigner.common,
        uom = MLB.sharedLib.uom;
...
MLB.NewtDesigner.binoscopeWorkflow = function () {
    var common = MLB.NewtDesigner.common,
        useSecondaryBendingAngle = MLB.NewtDesigner.useSecondaryBendingAngle,
...
MLB.NewtDesigner.displayFocalPlaneToSecondaryDistanceTooSmallError = function () {
    var config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        getBinoscopeMinimumFocalPlaneToSecondaryDistance = MLB.NewtDesigner.getBinoscopeMinimumFocalPlaneToSecondaryDistance,
        requiredDistance,
...
MLB.NewtDesigner.updateAEF = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
...
MLB.NewtDesigner.calcEyepieceWidestFieldForEyePupil = function (focalRatio, apertureInches, maxPupil) {
    ...
    $.each(eyepiecesJson.eyepieces, function (i, v) {
        ...
        FOV = calcFOVFromAperture_FocalRatio_EyepieceFieldStop_ComaCorrectorFactor(apertureInches, focalRatio, +v.fieldStopmm, comaCorrectorMag);
        eyePupil = calcPupilFromAperture_FOV_EyepieceFL_EyepieceFieldStop(apertureInches, FOV, +v.focalLengthmm, +v.fieldStopmm);
...
MLB.NewtDesigner.listWidestFieldEyepieces = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        eyepiecesJson = MLB.eyepiecesJson,
    ...
    $.each(eyepiecesJson.eyepieces, function (ix, e) {
        var FOV,
            eyePupil,
            magnification;
...
MLB.NewtDesigner.updateTelescopeResults = function () {
    ...
    common.telescopeDesignerResultsLabel().html('brightness gain = '
            ...
            + " magnitudes<br>William Herschel's Space Penetrating Power based on combined mirrors' reflectivity of "
            + "<input class='inputText' id='combinedMirrorsReflectivity' onfocus='select();' type='text'>"
            + " = <label id='spacePenetratingPowerLabel'> </label>"
            + '<br>Dawes\' Limit = '
            + roundToDecimal(theoreticalResolutionArcsec, config.decimalPointsResolution)
            ...
            + uomLengthLit
            + '&nbsp;&nbsp;&nbsp;&nbsp; <a href="sagitta.html" target="_blank">Calculate focal length from sagitta</a>'
            ...
            + ' rpm (Coriolis Effect comes into play at 100 inches diameter [2.5m] and can be compensated for by tipping north or south<br>telescope diopter = '
    ...
    common.combinedMirrorsReflectivity().change(function () {
        ...
        MLB.NewtDesigner.calcAndDisplaySpacePenetratingPower(apertureInches);
    });
...
MLB.NewtDesigner.drawPoints54Helper = function (pointsToDraw, xyOffsetsFromMirrorCenter, scalingFactor, context, centerPt) {
    ...
    pointsToDraw.forEach((vp, ip, ap) => { // value, index, array
...
MLB.NewtDesigner.processURLhash = function () {
    ...
    case jumpTo.whatDoesATelescopeDo:
        updateSelectedThenScrollToTop(common.btnWhatDoesATelescopeDo(), config.btnSelectIntroLit, config.designIntroLit, config.designIntroImageLit, undefined);
        break;
    case jumpTo.whoInventedTheReflectingTelescope:
        updateSelectedThenScrollToTop(common.btnWhoInventedTheReflectingTelescope(), config.btnSelectIntroLit, config.designIntroLit, config.designIntroImageLit, jumpTo.whoInventedTheReflectingTelescope);
        break;
    ...
    case jumpTo.telescope:
        updateSelectedThenScrollToTop(undefined, config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    case jumpTo.focalLengthApertureFocalRatio:
        updateSelectedThenScrollToTop(common.btnFocalLengthApertureFocalRatio(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.focalLengthApertureFocalRatio);
        break;
    case jumpTo.comparingAperture:
        updateSelectedThenScrollToTop(common.btnComparingAperture(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.comparingAperture);
        break;
    case jumpTo.apertureManagement:
        ...
        break;
    case jumpTo.apertureEyepieceFOV:
        updateSelectedThenScrollToTop(common.btnApertureEyepieceFOV(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.apertureEyepieceFOV);
        break;
    case jumpTo.resolution:
        updateSelectedThenScrollToTop(common.btnResolution(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.resolution);
        break;
    ...
    case jumpTo.telescopeValue:
        updateSelectedThenScrollToTop(common.btnBartelsEquation(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.telescopeValue);
        break;
    case jumpTo.telescopePerformance:
        updateSelectedThenScrollToTop(common.btnTelescopePerformance(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.telescopePerformance);
        break;
    case jumpTo.fieldCurvature:
        updateSelectedThenScrollToTop(common.btnFieldCurvature(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.fieldCurvature);
        break;
    ...
    case jumpTo.foldingSlidingScopes:
        updateSelectedThenScrollToTop(common.btnFoldingSlidingScopes(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.foldingSlidingScopes);
        break;
    case jumpTo.selectingTelescope:
        updateSelectedThenScrollToTop(common.btnSelectingTelescope(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.telescopeRequirements);
        break;
    case jumpTo.RFT:
        updateSelectedThenScrollToTop(common.btnRFT(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.RFT);
        break;
    case jumpTo.etendue:
        updateSelectedThenScrollToTop(common.btnEtendue(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.etendue);
        break;
    case jumpTo.HET:
        updateSelectedThenScrollToTop(common.btnHET(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.HET);
        break;
    case jumpTo.HETrealWorldComparison:
        updateSelectedThenScrollToTop(common.btnHETrealWorldComparison(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.HETrealWorldComparison);
        break;
    case jumpTo.designingWithEtendue:
        updateSelectedThenScrollToTop(common.btnDesigningWithEtendue(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.designingWithEtendue);
        break;
    case jumpTo.designByExitPupil:
        updateSelectedThenScrollToTop(common.btnDesignByExitPupil(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.designByExitPupil);
        break;
    case jumpTo.designByTrueField:
        updateSelectedThenScrollToTop(common.btnDesignByTrueField(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.designByTrueField);
        break;
    case jumpTo.comboScopes:
        updateSelectedThenScrollToTop(common.btnComboScopes(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.comboScopes);
        break;
    case jumpTo.collimation:
        updateSelectedThenScrollToTop(common.btnCollimation(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.collimation);
        break;
    case jumpTo.formulae:
        updateSelectedThenScrollToTop(common.btnUsefulFormulae(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jumpTo.formulae);
        break;
    // visual detection
    ...
    case jumpTo.visualUom:
        updateSelectedThenScrollToTop(common.btnVisualUom(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualUom);
        break;
    case jumpTo.visualMagnitudeScale:
        updateSelectedThenScrollToTop(common.btnVisualMagnitudeScale(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualMagnitudeScale);
        break;
    case jumpTo.visualBortleScale:
        updateSelectedThenScrollToTop(common.btnVisualBortleScale(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualBortleScale);
        break;
    case jumpTo.visualSkyBackgroundBrightness:
        updateSelectedThenScrollToTop(common.btnSkyBackgroundBrightness(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualSkyBackgroundBrightness);
        break;
    case jumpTo.visualObjectBrightness:
        updateSelectedThenScrollToTop(common.btnVisualObjectBrightness(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualObjectBrightness);
        break;
    case jumpTo.visualHowFaint:
        updateSelectedThenScrollToTop(common.btnVisualHowFaint(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualHowFaint);
        break;
    case jumpTo.visualObjectTypes:
        updateSelectedThenScrollToTop(common.btnVisualObjectTypes(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualObjectTypes);
        break;
    case jumpTo.visualHowToLookThroughEyepiece:
        updateSelectedThenScrollToTop(common.btnVisualHowToLookThroughEyepiece(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualHowToLookThroughEyepiece);
        break;
    case jumpTo.visualObservingLanguage:
        updateSelectedThenScrollToTop(common.btnVisualObservingLanguage(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualObservingLanguage);
        break;
    case jumpTo.visualPsychology:
        updateSelectedThenScrollToTop(common.btnVisualPsychology(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualPsychology);
        break;
    case jumpTo.visualMagnification:
        updateSelectedThenScrollToTop(common.btnVisualMagnification(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualMagnification);
        break;
    case jumpTo.visualWideField:
        updateSelectedThenScrollToTop(common.btnVisualWideField(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualWideField);
        break;
    case jumpTo.visualBinoscopes:
        updateSelectedThenScrollToTop(common.btnVisualBinoscopes(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualBinoscopes);
        break;
    case jumpTo.visualObservingFactors:
        updateSelectedThenScrollToTop(common.btnVisualObservingFactors(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualObservingFactors);
        break;
    case jumpTo.visualNightVisionDevices:
        updateSelectedThenScrollToTop(common.btnVisualNightVisionDevices(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualNightVisionDevices);
        break;
    case jumpTo.visualTipsImproveObserving:
        updateSelectedThenScrollToTop(common.btnVisualTipsImproveObserving(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualTipsImproveObserving);
        break;
    case jumpTo.visualPlanningObservations:
        updateSelectedThenScrollToTop(common.btnVisualPlanningObservations(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualPlanningObservations);
        break;
    case jumpTo.visualReferences:
        updateSelectedThenScrollToTop(common.btnVisualReferences(), config.btnSelectVisualLit, config.designVisualLit, config.designVisualImageLit, jumpTo.visualReferences);
        break;
    // eyepieces
    case jumpTo.eyepieces:
        updateSelectedThenScrollToTop(undefined, config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    case jumpTo.exitPupil:
        updateSelectedThenScrollToTop(common.btnExitPupil(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, jumpTo.exitPupil);
        break;
    case jumpTo.oversizedExitPupil:
        updateSelectedThenScrollToTop(common.btnOversizedExitPupil(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, jumpTo.oversizedExitPupil);
        break;
    case jumpTo.magnification:
        updateSelectedThenScrollToTop(common.btnMagnification(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, jumpTo.magnification);
        break;
    case jumpTo.stoppingDownMatchingApertureWithEyeResolution:
        updateSelectedThenScrollToTop(common.btnStoppingDownMatchingApertureWithEyeResolution(), config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit, jumpTo.stoppingDownMatchingApertureWithEyeResolution);
        break;
    // coma corrector
    ...
    case jumpTo.optimizeDiagonalSize:
        updateSelectedThenScrollToTop(common.btnOptimizeDiagonalSize(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, jumpTo.optimizeDiagonalSize);
        break;
    ...
    case jumpTo.offAxisMask:
        updateSelectedThenScrollToTop(common.btnOffAxisMask(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, jumpTo.offAxisMask);
        break;
    // spider and diffraction
    ...
    // focuser
    case jumpTo.focuser:
        updateSelectedThenScrollToTop(undefined, config.btnSelectFocuserLit, config.designFocuserLit, config.designFocuserImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // optical layout, baffling
    case jumpTo.opticalLayoutBaffling:
        updateSelectedThenScrollToTop(undefined, config.btnSelectBafflingLit, config.designBafflingLit, config.designBafflingImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // lowrider layout, baffling
    case jumpTo.lowrider:
        updateSelectedThenScrollToTop(undefined, config.btnSelectLowriderBafflingLit, config.designLowriderBafflingLit, config.designLowriderBafflingImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // binoscope
    case jumpTo.binoscope:
        updateSelectedThenScrollToTop(undefined, config.btnSelectBinoscopeLit, config.designBinoscopeLit, config.designBinoscopeImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // center of gravity
    case jumpTo.COG:
        updateSelectedThenScrollToTop(undefined, config.btnSelectCGLit, config.designCGLit, config.designCGImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // tube types
    ...
    case jumpTo.ballscopes:
        updateSelectedThenScrollToTop(common.btnBallscopes(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, jumpTo.ballscopes);
        break;
    case jumpTo.EarlOfCrawford:
        updateSelectedThenScrollToTop(common.btnEarlOfCrawford(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, jumpTo.EarlOfCrawford);
        break;
    case jumpTo.threeAxisMounts:
        updateSelectedThenScrollToTop(common.btnThreeAxisMounts(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, jumpTo.threeAxisMounts);
        break;
    case jumpTo.Holcombe:
        updateSelectedThenScrollToTop(common.btnHolcombe(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, jumpTo.Holcombe);
        break;
    case jumpTo.Morse:
        updateSelectedThenScrollToTop(common.btnMorse(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, jumpTo.Morse);
        break;
    // rocker
    case jumpTo.rocker:
        updateSelectedThenScrollToTop(undefined, config.btnSelectRockerLit, config.designRockerLit, config.designRockerImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    case jumpTo.movementFriction:
        updateSelectedThenScrollToTop(undefined, config.btnSelectRockerLit, config.designRockerLit, config.designRockerImageLit, jumpTo.movementFriction);
        break;
    // flex rocker
    case jumpTo.flexRocker:
        updateSelectedThenScrollToTop(undefined, config.btnSelectFlexRockerLit, config.designFlexRockerLit, config.designFlexRockerImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    // equatorial table
    case jumpTo.ET:
        updateSelectedThenScrollToTop(undefined, config.btnSelectETLit, config.designETLit, config.designETImageLit, config.uomFocalRatioApertureSharedParmsLit);
        break;
    case jumpTo.omniLatitudeET:
        updateSelectedThenScrollToTop(common.btnOmniLatitudeET(), config.btnSelectETLit, config.designETLit, config.designETImageLit, jumpTo.omniLatitudeET);
        break;
    case jumpTo.turretET:
        updateSelectedThenScrollToTop(common.btnTurretET(), config.btnSelectETLit, config.designETLit, config.designETImageLit, jumpTo.turretET);
        break;
    case jumpTo.tiltET:
        updateSelectedThenScrollToTop(common.btnTiltET(), config.btnSelectETLit, config.designETLit, config.designETImageLit, jumpTo.tiltET);
        break;
    // export and import designs
   ...
   case jumpTo.design30inch:
    ...
    case jumpTo.proposedDesign30inchBinoscope:
        ...
        break;
    default:
        alert('Unknown URL hash of #' + hash + ' in processURLhash()');
    }
};

MLB.NewtDesigner.setBinoscopeLocksDistanceLogic = function () {
    var common = MLB.NewtDesigner.common;
