...
$(window).ready(function () {
    ...
    if (window.location.hash) {
        if (window.location.hash.substring(1) === config.jumpTo.diagonal) {
            updateSelected(config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.uomFocalRatioApertureSharedParmsLit).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.telescopeValue) {
            updateSelected(config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.telescopeValue).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.telescopePerformance) {
            updateSelected(config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.telescopePerformance).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.apertureManagement) {
            updateSelected(config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.apertureManagement).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.formulae) {
            updateSelected(config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.formulae).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.magnification) {
            updateSelected(config.btnSelectEyepiecesLit, config.designEyepiecesLit, config.designEyepieceImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.magnification).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.offAxisMask) {
            updateSelected(config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.offAxisMask).offset().top
            });
        } else if (window.location.hash.substring(1) === config.jumpTo.movementFriction) {
            updateSelected(config.btnSelectRockerLit, config.designRockertLit, config.designRockerImageLit);
            $('html,body').animate({
                scrollTop: $('#' + config.jumpTo.movementFriction).offset().top
            });
        }
    }
});
