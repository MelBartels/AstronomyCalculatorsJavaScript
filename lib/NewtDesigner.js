...
MLB.NewtDesigner.updateFieldsDependentOnFocalRatio = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        ...
        focalRatio = common.focalRatioVal(),
        telescopeFocalLength = roundToDecimal(focalRatio * common.apertureVal(), config.decimalPointsTelescopeFocalLength);

    // update telescope focal length input number box and slider
...
MLB.NewtDesigner.updateFieldsDependentOnTelescopeFocalLength = function () {
    ...
    // update telescope focal ratio input number box and slider
