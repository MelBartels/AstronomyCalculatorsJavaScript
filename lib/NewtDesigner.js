...
MLB.NewtDesigner.updateLowriderBaffleDesignerFromBaffleDesigner = function () {
    ...
    common.lowriderSecondaryMirrorSize().val(roundToDecimal(common.sharedDiagSizeVal(), config.decimalPointsDiag));
    common.focalPlaneToSecondaryDistance().val(roundToDecimal(common.sharedDiagSizeVal() * common.focalRatioVal(), config.decimalPointsDimension));
