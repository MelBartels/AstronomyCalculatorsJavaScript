...
MLB.NewtDesigner.plotRangeOfVisualDetections = function () {
    ...
    for (apIx = 0; apIx < 3; apIx += 1) {
        ...
        Bortles = [];
        for (BortleLevel = 1; BortleLevel <= 8; BortleLevel += 1) {
...
MLB.NewtDesigner.calcEyepieceWidestFieldForEyePupil = function (focalRatio, apertureInches, maxPupil) {
    ...
    $.each(eyepiecesJson.eyepieces, function (i, v) {
        ...
        eyePupil = calcEyePupilFromAperture_FOV_EyepieceFL_EyepieceFieldStop(apertureInches, FOV, +v.focalLengthmm, +v.fieldStopmm);
...
MLB.NewtDesigner.listWidestFieldEyepieces = function () {
    ...
    $.each(eyepiecesJson.eyepieces, function (ix, e) {
        ...
        eyePupil = calcEyePupilFromAperture_FOV_EyepieceFL_EyepieceFieldStop(apertureInches, FOV, +e.focalLengthmm, +e.fieldStopmm);
    ...
    mappedTop = topWidestFieldEyepieces.map(e => ({'FOV': e.FOV,
            ...
            'eyepiece': e.eyepiece.manufacturer + ' ' + e.eyepiece.type + ' ' + e.eyepiece.focalLengthmm + 'mm ' + e.eyepiece.apparentField + 'deg'
    }));
...
MLB.NewtDesigner.buildData = function () {
    ...
    return {
        ...
        AEFUseComaCorrector: common.AEFUseComaCorrector(),
