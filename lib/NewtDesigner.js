...
MLB.NewtDesigner.attemptToUpdateBinoscopeBasedOnBendingAngle = function () {
    var common = MLB.NewtDesigner.common,
        updateBinoscopeFocalPlaneToSecondaryDistanceBasedOnBendingAngle = MLB.NewtDesigner.updateBinoscopeFocalPlaneToSecondaryDistanceBasedOnBendingAngle,
        graphBinoscope = MLB.NewtDesigner.graphBinoscope,
        graphBinoscopeFrontView = MLB.NewtDesigner.graphBinoscopeFrontView;

    if (common.binoscopeChBoxLockSecondaryBendingAngleChecked() && !isNaN(common.binoscopeSecondaryBendingAngleDegVal()) && common.binoscopeSecondaryBendingAngleDegVal() > 0) {
        updateBinoscopeFocalPlaneToSecondaryDistanceBasedOnBendingAngle();
        graphBinoscope();
...
MLB.NewtDesigner.updateBinoscopeFocalPlaneToSecondaryDistanceBasedOnBendingAngle = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        uom = MLB.sharedLib.uom,
...
$(window).ready(function () {
    var state = MLB.NewtDesigner.state,
        ...
        graphFlexRocker = MLB.NewtDesigner.graphFlexRocker,
        graphEquatorialTable = MLB.NewtDesigner.graphEquatorialTable,
        attemptToUpdateBinoscopeBasedOnBendingAngle = MLB.NewtDesigner.attemptToUpdateBinoscopeBasedOnBendingAngle,
        updateCurrentlySelectedDesigner = MLB.NewtDesigner.updateCurrentlySelectedDesigner,
    ...
    common.binoscopeChBoxLockSecondaryBendingAngle().click(attemptToUpdateBinoscopeBasedOnBendingAngle);
    common.binoscopeSecondaryBendingAngleDeg().change(attemptToUpdateBinoscopeBasedOnBendingAngle);
    common.btnUpdateBinoscope().click(function () {
        if (!attemptToUpdateBinoscopeBasedOnBendingAngle()) {
            graphBinoscope();
            graphBinoscopeFrontView();
        }
    });
