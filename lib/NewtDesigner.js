...
MLB.NewtDesigner.updateBinoscopeFocalPlaneToSecondaryDistance = function () {
    ...
    common.binoscopeFocalPlaneToSecondaryDistance().val(roundToDecimal(calcBinoscopeFocalPlaneToSecondaryDistance() - shortenedDistanceDueToTertiaryBendingAngle, config.decimalPointsDimension));
};
