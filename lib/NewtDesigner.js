...
MLB.NewtDesigner.graphFocuserBaffles = function () {
    ...
    // build canvas, context
    common.focuserBaffleCanvasDiv().append(buildCanvasElement('focuserBaffleCanvas', common.baffleCanvasID().width, common.baffleCanvasID().height));
...
MLB.NewtDesigner.binoscopeWorkflow = function () {
    ...
    if (secondaryBendingAngleLocked || useSecondaryBendingAngle()) {
        // reset focal plane to secondary distance
...
$(window).ready(function () {
    ...
    common.binoscopeEyepieceDivergenceDeg().change(binoscopeWorkflow);
