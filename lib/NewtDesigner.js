...
MLB.NewtDesigner.updateTelescopeResults = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        ...
        collimationToleranceFocuser,
        collimationTolerancePrimaryMirror,
        brightnessGain,
        sagittaSpherical,
        sagittaParabolic,
        sagittalVolume,
    ...
    collimationTolerance = common.convertInchesToUom(calcCollimationToleranceInches(apertureInches, focalRatio));
    ...
    common.telescopeDesignerResultsLabel().html('brightness gain = '
            ...
            + roundToDecimal(collimationTolerance.primaryMirrorAlignment, config.decimalPointsComaFreeDiameter)
            + uomLengthLit
            + ' and collimation tolerance (focuser projected onto the primary mirror) = '
            + roundToDecimal(collimationTolerance.focuserAlignment, config.decimalPointsComaFreeDiameter)
            + uomLengthLit
