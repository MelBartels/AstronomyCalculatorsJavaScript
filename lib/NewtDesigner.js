...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
	...
	// after setting btnEyepieceList() now fill eyepiece row options with correct eyepiece data sorted by manufacturer
...
$(window).ready(function () {
	...
	common.btnEyepieceList().click(() => {
		var removeEyeOptSelectedEyepiece = MLB.NewtDesigner.removeEyeOptSelectedEyepiece,
			eyepieceRow;
