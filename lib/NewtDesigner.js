...
MLB.NewtDesigner.processURLhash = function () {
    ...
    case jumpTo.selectingTelescope:
        updateSelectedThenScrollToTop(common.btnSelectingTelescope(), config.btnSelectTelescopeLit, config.designTelescopeLit, config.designTelescopeImageLit, jhash);
        break;
