...
MLB.NewtDesigner.calcVignettedIllumPercent = function (diagSize) {
	...
	illumArray = getDiagFocuserIllumArray(aperture, focalLength, diagSize, focalPlaneToDiagDistance, offAxisIncrement, maxFieldDia, focuserBarrelTubeID, focuserBarrelTubeLength, includeFocuserBarrelVignetting);
...
MLB.NewtDesigner.graphDiagIllum = function () {
	...
	for (ix = 0; ix < suitableDiagsLength; ix += 1) {
		illumArray = getDiagFocuserIllumArray(aperture, focalLength, diag.suitableDiags[ix], focalPlaneToDiagDistance, offAxisIncrement, maxFieldDia, focuserBarrelTubeID, focuserBarrelTubeLength, includeFocuserBarrelVignetting);
