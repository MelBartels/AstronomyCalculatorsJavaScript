...
MLB.NewtDesigner.writeDiagResults = () => {
	...
	common.diagResults().html('Smallest possible diagonal  = '
			...
			+ centralObstructionsStr
			+ '<br><br>Equivalent resolution non-obstructured aperture: '
			+ equivalentResoutionApertureStr
...
MLB.NewtDesigner.graphBinoscope = () => {
	...
	// points
	eyepieceDivergenceAngleRad = eyepieceDivergenceAngleDeg * uom.degToRad;
	eyepieceHalfWidthX = Math.sin(eyepieceDivergenceAngleRad) * scaling.eyepieceHalfWidth;
	eyepieceHalfWidthY = Math.cos(eyepieceDivergenceAngleRad) * scaling.eyepieceHalfWidth;
