...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
	...
	// after much manipulation: adding/removing eyepieces, sorting the eyepieces, then adding/removing more eyepieces, then importing --- the eyepieces occasionally have unselected eyepiece rows intermingled;
	// so force a short to compact the eyepiece rows
