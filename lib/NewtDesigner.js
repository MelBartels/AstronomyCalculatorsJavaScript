...
MLB.NewtDesigner.seedEyeOptEyepiece = function (idIx, manufacturer, type, focalLengthmm, apparentField) {
    var config = MLB.NewtDesigner.config,
    ...
    $('#' + config.EyeOptSelectID + idIx).val(manufacturer + ' ' + type + ' ' + focalLengthmm + config.mmLitNS + ' ' + apparentField);
...
MLB.NewtDesigner.getLocalStorageName = function () {
    ...
    return config.NewtDesignerLit + common.designName().val();
};
...
MLB.NewtDesigner.getDataUpdateUI = function () {
    ...
    if (parsedData.useComaCorrector) {
        common.chBoxUseComaCorrector().prop('checked', true);
    } else {
        common.chBoxUseComaCorrector().prop('checked', false);
    }
    ...
    while (true) {
        ...
        if (manufacturerStr) {
            eyepieceStr = manufacturerStr
                    ...
                    + ' '
                    + common.tableElement(config.EyeOptApparentFieldID, ix).html();
...
$(window).ready(function () {
    ...
    seedEyeOptEyepiece(0, 'TeleVue', 'Nagler 5', '31', '82deg');
    seedEyeOptEyepiece(1, 'Nikon', 'NAV', '17', '102deg');
    seedEyeOptEyepiece(2, 'Clave', 'Plossl', '6', '48deg');
