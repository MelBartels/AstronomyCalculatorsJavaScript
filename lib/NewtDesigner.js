...
MLB.NewtDesigner.config = {
    ...
    */
    ...
    diagOffsetFieldEdgeLabelLit: 'Diagonal offset balancing edge of field illumination (towards primary mirror and away from focuser)',
...
MLB.NewtDesigner.plotSQMsForObjectContrasts = function () {
    var config = MLB.NewtDesigner.config,
        common = MLB.NewtDesigner.common,
        objMag = objMag = common.objectApparentMagnitudeVal(),
        objectSize1Arcmin = common.objectSizeArcMin1Val(),
        objectSize2Arcmin = common.objectSizeArcMin2Val(),
