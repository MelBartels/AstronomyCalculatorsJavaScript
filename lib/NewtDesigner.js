...
MLB.NewtDesigner.updateTelescopeResults = function () {
    ...
    glassRemovedDuringPolishingCubicInches = glassRemovalDuringPolishingFrom10MicronAluminumOxideCubicInches(apertureInches);
    ...
    common.telescopeDesignerResultsLabel().html('brightness gain = '
            ...
            + uomLengthLit
            + '^3<br>rotate liquid to match sagitta at '
