...
MLB.NewtDesigner.config = {
    version: 'Last updated 12-April-2020',
...
MLB.NewtDesigner.updateFieldsDependentOnFocalRatio = function () {
    ...
    // each baffle designer, if seledted, updates values dependent on focal ratio updated in updateCurrentlySelectedDesigner()
...
MLB.NewtDesigner.updateFieldsDependentOnAperture = function () {
    ...
    // each baffle designer, if seledted, updates values dependent on aperture updated in updateCurrentlySelectedDesigner()
    updateCurrentlySelectedDesigner();
};
...
MLB.NewtDesigner.updateFieldsDependentOnTelescopeFocalLength = function () {
    ...
    // each baffle designer, if seledted, updates values dependent on focal length updated in updateCurrentlySelectedDesigner()
    updateCurrentlySelectedDesigner();
};
...
$(window).ready(function () {
    ...
    common.btnUpdateBinoscope().click(graphBinoscope);
