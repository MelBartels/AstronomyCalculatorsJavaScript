...
MLB.NewtDesigner.config = {
    ...
    // designers: need three literals: button, designer div and image div
...
MLB.NewtDesigner.updateTelescopeResults = function () {
    ...
    collimationTolerance = common.convertUomToInches(calcCollimationToleranceInches(focalRatio));
