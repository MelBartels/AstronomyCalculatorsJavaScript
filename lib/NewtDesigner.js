...
MLB.NewtDesigner.writeDiagResults = () => {
	...
	common.diagResults().html('Smallest possible diagonal  = '
			...
			+ centralObstructionsStr
			+ '<br><br>Resolution equivalent to non-obstructured aperture of: '
			+ equivalentResoutionApertureStr
			+ '(see comments below)<br><br>RMS wave deformations due to central obstruction are '
			+ RMSCausedByCentralObstructionStr
			+ '<br><br>'
...
MLB.NewtDesigner.graphBinoscope = () => {
	...
	resultsString = 'secondary mirror: tilted at '
			...
			+ uomLengthLit
			+ '; &emsp; vertical height: secondary to focal point = '
			...
			+ uomLengthLit
			+ '; &emsp; vertical height: edge of mirror to eyepiece end = '
