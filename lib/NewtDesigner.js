...
MLB.NewtDesigner.config = {
    version: '0.4.5',
    titleText: '<h2>Newtonian Telescope Designer by Mel Bartels, version 0.4.5</h2>',
...
MLB.NewtDesigner.putData = function () {
    ...
    common.textareaDesignData().text(JSONdata);
...
MLB.NewtDesigner.importMelBartelsZipDobIIDesign = function () {
    ...
    common.textareaDesignData().text(JSON.stringify(MelBartelsZipDobIIDesignData, null, 4));
...
MLB.NewtDesigner.updateTelescopeResults = function () {
    ...
    common.telescopeDesignerResultsLabel().html('telescope focal length = '
            ...
            + uomLengthLit
            + '<br>mirror support points required = '
            + mirrorSupportPoints
            + '<br>mirror sagitta = '
            + roundToDecimal(sagitta, config.decimalPointsDimension)
            + uomLengthLit
