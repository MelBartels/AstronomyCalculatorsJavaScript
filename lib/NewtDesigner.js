...
MLB.NewtDesigner.common = {
	...
	btnEyepieceTableSort: function () {
		return $('[name=btnEyepieceTableSort]');
	},
	sortEyepieceTableByFL: function () {
		return this.btnEyepieceTableSort()[0].checked;
	},
	sortEyepieceTableByTrueField: function () {
		return this.btnEyepieceTableSort()[1].checked;
	},
...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
	...
	// don't process btnEyepieceTableSort because sort determined by btnEyepieceSort above
...
$(window).ready(function () {
	...
	common.btnEyepieceSort().click(function () {
		if (common.sortEyepiecesByManufacturer()) {
			...
			alert('cannot sort eyepieces: unknown sort selection checked');
		}
	});
	common.btnEyepieceTableSort().click(function () {
		if (common.sortEyepieceTableByFL()) {
			sortEyepieceTable(config.focalLengthIx);
		} else if (common.sortEyepieceTableByTrueField()) {
			sortEyepieceTable(config.trueFieldOfViewIx);
		} else {
			alert('cannot sort eyepiece table: unknown sort selection checked');
		}
	});
