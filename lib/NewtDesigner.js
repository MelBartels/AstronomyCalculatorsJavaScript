// copyright Mel Bartels, 2016 - 2026
...
MLB.NewtDesigner.state = {
	...
	sliderBinoscopeFocalPlaneToSecondaryDistanceChanging: undefined,
	sliderBinoscopeFocalPlaneToTertiaryDistanceChanging: undefined,
	sliderBinoscopeSecondaryBendingAngleDegChanging: undefined,
	sliderBinoscopeIPDChanging: undefined,
	sliderBinoscopeEyepieceDivergenceDeg: undefined,
	sliderBinoscopeSecondaryAxisDownwardTiltAngleDegChanging: undefined,
	sliderBinoscopeEyepieceLengthChanging: undefined,
	sliderBinoscopeScaleChanging: undefined,
	sliderFocuserScaleChanging: undefined,
	sliderBaffleScaleChanging: undefined,
	sliderLowriderScaleChanging: undefined,
	sliderRockerScaleChanging: undefined,
	sliderFlexRockerScaleChanging: undefined,
	sliderETScaleChanging: undefined,

	// starting values: user can change
	sliderBinoscopeScaleValue: 1,
	sliderFocuserScaleValue: 1,
	sliderBaffleScaleValue: 1,
	sliderLowriderScaleValue: 1,
	sliderRockerScaleValue: 1,
	sliderFlexRockerScaleValue: 1,
	sliderETScaleValue: 1,
...
MLB.NewtDesigner.config = {
	...
	jumpTo: {
		...
		etendue: 'etendue',
		EyeEtendueScopeObservation: 'EyeEtendueScopeObservation',
		HET: 'HET',
		lowMags: 'lowMags',
		...
		// diagonal designer
		diagonal: 'diagonal',
		diagonalInterpretation: 'diagonalInterpretation',
		diagonalOffset: 'diagonalOffset',
		diagonalObstructionResolution: 'diagonalObstructionResolution',
		...
		// binoscope
		binoscope: 'binoscope',
		binoscopeDivergentEyepieces: 'binoscopeDivergentEyepieces',
		binoscopeVisualObs: 'binoscopeVisualObs',
		OSPBinoscopes: 'OSPBinoscopes',
		binoscopeDesign: 'binoscopeDesign',
		binoscope3Dprinting: 'binoscope3Dprinting',
		binoscopeHistory: 'binoscopeHistory',
		binoscopeResources: 'binoscopeResources',
		// center of gravity
		COG: 'COG',
		// tube types
		tubeTypes: 'tubeTypes',
	...
	*/
	...
	focalPlaneToSecondaryDistanceLabelLit: 'Secondary to focal slanted distance',
	focalPointPerpendicularOffsetFromEdgeOfPrimaryLabelLit: 'Focal point perpendicular height from top edge of primary',
	binoscopeFocalPlaneToSecondaryDistanceLabelLit: 'Total bending: secondary to focal plane length',
	binoscopeFocalPlaneToTertiaryDistanceLabelLit: 'Final bend: tertiary to focal plane distance',
	binoscopeEyepieceLengthLabelLit: 'Eyepiece length (shoulder to eye)',
	...
	maxPupil: 7,
	widestEyepieceFOVTopDisplayCount: 20,
	...
	comaCorrectorManufacturer: 'TeleVue',
	comaCorrectorModel: 'Paracorr II',
	eyepiece1: 'Tele Vue: TVO Nagler5 31mm',
	eyepiece2: 'Nikon: NIK NAV-HW 17mm',
	eyepiece3: 'Clave: Plossl 6mm',
	...
	decimalPointsEyepieceApparentFOV: 1,
	...
	primaryMirrorToFocalPlaneDimensionText: 'primary mirror front edge to focal point (P1) = ',
	...
	primaryMirrorToSecondaryMirrorText: 'primary mirror center to secondary mirror = ',
	primaryMirrorToP3MirrorText: 'primary mirror center to focal plane (P3) = ',
	primaryMirrorToEyepieceEndText: 'primary mirror center to end of eyepiece = ',
	mirrorEdgesSeparation: 'mirror edges separation = ',
	...
	maxRecommendedMirrorSurfaceAreaPerSupportPoint: 35,
	...
	humanEyeRadiusInches: 0.5,
	eyepieceWidthInches: 1.25,
...
MLB.NewtDesigner.common = {
	...
	// coma corrector
	// diagonal
	btnDiagonalInterpretation: function () {
		return $('[id=btnDiagonalInterpretation]')[0];
	},
	btnDiagonalOffset: function () {
		return $('[id=btnDiagonalOffset]')[0];
	},
	btnDiagonalObstructionResolution: function () {
		return $('[id=btnDiagonalObstructionResolution]')[0];
	},
	...
	btnMirrorMeniscus: function () {
		return $('[id=btnMirrorMeniscus]')[0];
	},
	...
	// lowrider layout, baffling
	// binoscope
	btnBinoscopeDivergentEyepieces: function () {
		return $('[id=btnBinoscopeDivergentEyepieces]')[0];
	},
	...
	btnBinoscopeHistory: function () {
		return $('[id=btnBinoscopeHistory]')[0];
	},
	btnBinoscopeResources: function () {
		return $('[id=btnBinoscopeResources]')[0];
	},
	// center of gravity
	// tube types
	// mount types
	...
	minimumMeniscusMirrorThicknessLabel: function () {
		return $('[id=minimumMeniscusMirrorThicknessLabel]');
	},
	...
	btnEyepieceList: function () {
		return $('[name=btnEyepieceList]');
	},
	btnEyepieceListValue: function () {
		return $("input[name=btnEyepieceList]:checked").val();
	},
	...
	objSurfBright: function () {
		return $('[id=objSurfBright]');
	},
	objSurfBrightVal: function () {
		return +this.objSurfBright().val();
	},
	skySurfBright: function () {
		return $('[id=skySurfBright]');
	},
	skySurfBrightVal: function () {
		return +this.skySurfBright().val();
	},
	ContrastCalcLabel: function () {
		return $('[id=ContrastCalcLabel]');
	},
	...
	sliderFocuserScale: function () {
		return $('[id=sliderFocuserScale]');
	},
	sliderFocuserScaleVal: function () {
		return +this.sliderFocuserScale().val();
	},
	...
	sliderBaffleScale: function () {
		return $('[id=sliderBaffleScale]');
	},
	sliderBaffleScaleVal: function () {
		return +this.sliderBaffleScale().val();
	},
	...
	sliderLowriderScale: function () {
		return $('[id=sliderLowriderScale]');
	},
	sliderLowriderScaleVal: function () {
		return +this.sliderLowriderScale().val();
	},
	...
	sliderBinoscopeFocalPlaneToSecondaryDistance: function () {
		return $('[id=sliderBinoscopeFocalPlaneToSecondaryDistance]');
	},
	sliderBinoscopeFocalPlaneToSecondaryDistanceVal: function () {
		return +this.sliderBinoscopeFocalPlaneToSecondaryDistance().val();
	},
	...
	sliderBinoscopeFocalPlaneToTertiaryDistance: function () {
		return $('[id=sliderBinoscopeFocalPlaneToTertiaryDistance]');
	},
	sliderBinoscopeFocalPlaneToTertiaryDistanceVal: function () {
		return +this.sliderBinoscopeFocalPlaneToTertiaryDistance().val();
	},
	...
	binoscopeEyepieceDivergenceAngleDeg: function () {
		return $('[id=binoscopeEyepieceDivergenceAngleDeg]');
	},
	binoscopeEyepieceDivergenceDegVal: function () {
		return +this.binoscopeEyepieceDivergenceAngleDeg().val();
	},
	...
	sliderBinoscopeIPD: function () {
		return $('[id=sliderBinoscopeIPD]');
	},
	sliderBinoscopeIPDVal: function () {
		return +this.sliderBinoscopeIPD().val();
	},
	binoscopeEyepieceLengthLabel: function () {
		return $('[id=binoscopeEyepieceLengthLabel]');
	},
	binoscopeEyepieceLength: function () {
		return $('[id=binoscopeEyepieceLength]');
	},
	binoscopeEyepieceLengthVal: function () {
		return +this.binoscopeEyepieceLength().val();
	},
	sliderBinoscopeEyepieceLength: function () {
		return $('[id=sliderBinoscopeEyepieceLength]');
	},
	sliderBinoscopeEyepieceLengthVal: function () {
		return +this.sliderBinoscopeEyepieceLength().val();
	},
	sliderBinoscopeScale: function () {
		return $('[id=sliderBinoscopeScale]');
	},
	sliderBinoscopeScaleVal: function () {
		return +this.sliderBinoscopeScale().val();
	},
	...
	sliderRockerScale: function () {
		return $('[id=sliderRockerScale]');
	},
	sliderRockerScaleVal: function () {
		return +this.sliderRockerScale().val();
	},
	...
	sliderFlexRockerScale: function () {
		return $('[id=sliderFlexRockerScale]');
	},
	sliderFlexRockerScaleVal: function () {
		return +this.sliderFlexRockerScale().val();
	},
	...
	sliderETScale: function () {
		return $('[id=sliderETScale]');
	},
	sliderETScaleVal: function () {
		return +this.sliderETScale().val();
	},
	ETResults: function () {
		return $('[id=ETResults]');
	},
...
MLB.NewtDesigner.eyepiecesJsonSelector = () => {
	var common = MLB.NewtDesigner.common;

	if (common.btnEyepieceList()[1].checked) {
		return MLB.eyepiecesJson;
	}
	return MLB.eyepiecesPriorMarch2026Json;
};
...
MLB.NewtDesigner.writeDiagResults = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		equivalentLightGatheringApertureStr = '',
		equivalentResoutionApertureStr = '',
		midSeriesIx,
	...
	diag.suitableDiags.map((diag, ix) => {
		equivalentLightGatheringApertureStr += '<b>'
				+ diag
				+ '</b>: '
	...
	diag.suitableDiags.map(diag => {
		equivalentResoutionApertureStr += '<b>'
				+ diag
				+ '</b>: '
				+ roundToDecimal(aperture - diag, config.decimalPointsDiag)
				+ uomLengthLit
				+ '; &emsp;';
	});
	...
	common.diagResults().html('Smallest possible diagonal  = '
			...
			+ diag.evenIllumSize
			+ uomLengthLit
			+ '<br><br>Illumination integrated across the field: '
			+ integratedVignettedIllumsStr
			+ '<br><br>Equivalent light gathering aperture ranges from field center to field edge: '
			+ equivalentLightGatheringApertureStr
			+ '<br><br>Central obstructions: '
			+ centralObstructionsStr
			+ '<br><br>Low contrast planetary detail equivalent non-obstructured aperture (see comments below): '
			+ equivalentResoutionApertureStr
			+ '<br><br>RMS wave deformations due to central obstruction are '
			+ RMSCausedByCentralObstructionStr
			+ '<br><br>'
...
MLB.NewtDesigner.graphBaffles = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		common = MLB.NewtDesigner.common,
		drawCanvasOutline = MLB.NewtDesigner.drawCanvasOutline,
		adjustScaling = MLB.NewtDesigner.adjustScaling,
		point = MLB.sharedLib.point,
		rect = MLB.sharedLib.rect,
		drawLine = MLB.sharedLib.drawLine,
		...
		calcMirrorRadian = MLB.calcLib.calcMirrorRadian,
		buildCanvasElement = MLB.sharedLib.buildCanvasElement,
		canvas,
		context,
		aperture,
	...
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderBaffleScaleValue);
	scaledAperture = scalingFactor * aperture;
	...
	mirrorRadian = calcMirrorRadian(focalRatio);
...
MLB.NewtDesigner.graphFocuserBaffles = () => {
	...
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderFocuserScaleValue);
...
MLB.NewtDesigner.graphLowrider = () => {
	...
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderLowriderScaleValue);
	scaledMainAxisLength = scalingFactor * state.lowriderModel.diagToPrimaryMirrorDistance;
	scaledAperture = scalingFactor * aperture;
	scaledRadiusCurvature = scaledAperture * focalRatio * 2;
	scaledMirrorRadius = scaledAperture / 2;
	scaledTelescopeFocalLength = scalingFactor * telescopeFocalLength;
	...
	scaledPrimaryMirrorCellThicknessInUom = scalingFactor * primaryMirrorCellThicknessInUom;
	scaledSagitta = scalingFactor * sagitta;
	scaledHalfDiagMajorAxisSize = scalingFactor * state.lowriderModel.diagMajorAxisSize / 2;
	scaledlowriderSecondaryOffset = scalingFactor * lowriderSecondaryOffset;
	...
	focalPt = point(mirrorCenterPt.x + scalingFactor * state.lowriderModel.focalPointToPrimaryMirrorDistance, mirrorCenterPt.y - scalingFactor * (aperture / 2 + focalPointPerpendicularOffsetFromEdgeOfPrimary));
	...
	state.lowriderModel.frontEndOfTubeToPrimaryMirrorDistance = (focuserBaffleRightPt.x - mirrorLowerFacePt.x) / scalingFactor;
	...
	*/
	...
	// write dimension for projected focuser baffle
	text = config.projectedBaffleDimensionText + roundToDecimal((focuserBaffleRightPt.x - focuserBaffleLeftPt.x) / scalingFactor, config.decimalPointsDimension) + uomLengthLit;
	...
	text = config.projectedBaffleDimensionText + roundToDecimal((diagBaffleRightPt.x - diagBaffleLeftPt.x) / scalingFactor, config.decimalPointsDimension) + uomLengthLit;
	...
	// write dimension for primary mirror baffle
	text = config.primaryMirrorBaffleDimensionText + roundToDecimal((primaryMirrorBaffleLowerFrontPt.x - mirrorLowerFacePt.x) / scalingFactor, config.decimalPointsDimension) + uomLengthLit;
	// keep same dimensionY
	...
	// calculated: text = config.primaryMirrorToFocalPlaneVerticalHeightText + roundToDecimal((mirrorUpperFacePt.y - focalPt.y) / scalingFactor, config.decimalPointsDimension) + uomLengthLit;
	...
	scaledFocalPlaneToFoldingMirrorSlantedDistance = Math.sqrt(Math.pow(focalPt.y - diagPt.y, 2) + Math.pow(focalPt.x - diagPt.x, 2)) / scalingFactor;
...
MLB.NewtDesigner.binoscopeWorkflow = () => {
	var graphBinoscope = MLB.NewtDesigner.graphBinoscope,
...
MLB.NewtDesigner.calcFocalPointOffsetFromEdgeOfPrimary = (aperture, focalPlaneToSecondaryDistance, focalPlaneToTertiaryDistance, secondaryBendingAngleRad, eyepieceDivergenceAngleRad) => {
	return Math.sin(secondaryBendingAngleRad) * (focalPlaneToSecondaryDistance - focalPlaneToTertiaryDistance) + Math.tan(eyepieceDivergenceAngleRad) * focalPlaneToTertiaryDistance - aperture / 2;
};

MLB.NewtDesigner.adjustScaling = (initialScale, adjustment) => {
	return initialScale * adjustment * adjustment;
};
...
MLB.NewtDesigner.graphBinoscope = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		drawRect = MLB.sharedLib.drawRect,
		drawHorizDimen = MLB.sharedLib.drawHorizDimen,
		drawText = MLB.sharedLib.drawText,
		canvas,
		context,
		points = {},
		uom = MLB.sharedLib.uom,
		...
		calcMirrorRadian = MLB.calcLib.calcMirrorRadian,
		uomLengthLit = common.getUomLengthLit(),
		// use the refactored binoscope calculator that deals with eyepiece divergence and the eyepiece's end
		calcBinoscope2 = MLB.calcLib.calcBinoscope2,
		binoscopeModel,
		adjustScaling = MLB.NewtDesigner.adjustScaling,
		scaling,
		scalingFactor,
	...
	eyepieceLength = common.binoscopeEyepieceLengthVal();
	// get the binoscope model
	state.binoscopeModel = calcBinoscope2(aperture, focalRatio, focalPlaneToTertiaryDistance, focalPlaneToSecondaryDistance, secondaryBendingAngleDeg, eyepieceDivergenceAngleDeg, maxFieldDia, eyepieceLength);
	...
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderBinoscopeScaleValue);

	// draw each portion for debugging and refactoring; includes calc vars, scaling, points and drawing...

	// mirror

	// calc vars, get from elsewhere
	sagitta = calcSagittaParabolic(aperture, focalRatio);
	mirrorRadian = calcMirrorRadian(focalRatio);
	primaryMirrorThicknessInUom = common.convertInchesToUom(state.mirrorEdgeThicknessInches);
	primaryMirrorCellThicknessInUom = common.convertInchesToUom(config.primaryMirrorCellThicknessInches);
	...
	points.P1 = point(points.mirror.center.x + scaling.telescopeFocalLength, points.mirror.center.y);
	// draw
	telescopeTubeRect = rect(points.tube.rearCenter.x, points.tube.rearCenter.y - scaling.telescopeTubeOD / 2, points.P1.x - points.tube.rearCenter.x, scaling.telescopeTubeOD);
	drawRect(context, config.canvasStructureLightStyle, config.canvasLineWidth, telescopeTubeRect);

	// optical path

	// scaling
	scaling.primaryMirrorToSecondaryHorizontalLength = scalingFactor * binoscopeModel.primaryMirrorToSecondaryHorizontalLength;
	...
	scaling.secondaryToP2HorizontalLength = scalingFactor * binoscopeModel.secondaryToP2HorizontalLength;
	scaling.secondaryToP2VerticalLength = scalingFactor * binoscopeModel.secondaryToP2VerticalLength;
	scaling.tertiaryToFocalPlaneHorizontalLength = scalingFactor * binoscopeModel.tertiaryToFocalPlaneHorizontalLength;
	scaling.tertiaryToFocalPlaneVerticalLength = scalingFactor * binoscopeModel.tertiaryToFocalPlaneVerticalLength;
	scaling.focalPlaneToEyepieceEndHorizontalLength = scalingFactor * binoscopeModel.focalPlaneToEyepieceEndHorizontalLength;
	scaling.focalPlaneToEyepieceEndVerticalLength = scalingFactor * binoscopeModel.focalPlaneToEyepieceEndVerticalLength;
	// points
	points.opticalPath = {};
	points.opticalPath.secondary = point(points.mirror.center.x + scaling.primaryMirrorToSecondaryHorizontalLength, points.mirror.center.y);
	points.opticalPath.tertiary = point(points.opticalPath.secondary.x + scaling.secondaryToTertiaryHorizontalLength, points.opticalPath.secondary.y - scaling.secondaryToTertiaryVerticalLength);
	points.opticalPath.P2 = point(points.opticalPath.secondary.x + scaling.secondaryToP2HorizontalLength, points.opticalPath.secondary.y - scaling.secondaryToP2VerticalLength);
	points.opticalPath.focalPlane = point(points.opticalPath.tertiary.x + scaling.tertiaryToFocalPlaneHorizontalLength, points.opticalPath.tertiary.y - scaling.tertiaryToFocalPlaneVerticalLength);
	points.opticalPath.eyepieceLength = point(points.opticalPath.focalPlane.x + scaling.focalPlaneToEyepieceEndHorizontalLength, points.opticalPath.focalPlane.y - scaling.focalPlaneToEyepieceEndVerticalLength);
	// draw primary mirror to P1 (prime focus)
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.mirror.center, points.P1);
	// draw secondary to tertiary
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.opticalPath.secondary, points.opticalPath.tertiary);
	// draw secondary to P2 (focus as projected by the secondary)
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.opticalPath.secondary, points.opticalPath.P2);
	// draw tertiary to focal plane as projected by the tertiary (P3)
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.opticalPath.tertiary, points.opticalPath.focalPlane);
	// draw focal plane to eyepieceLength
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.opticalPath.focalPlane, points.opticalPath.eyepieceLength);

	// eyepiece width at end of Eyepiece

	// scaling
	scaling.eyepieceHalfWidth = scalingFactor * common.convertInchesToUom(config.eyepieceWidthInches) / 2;
	// points
	eyepieceHalfWidthX = Math.sin(binoscopeModel.eyepieceDivergenceAngleRad) * scaling.eyepieceHalfWidth;
	eyepieceHalfWidthY = Math.cos(binoscopeModel.eyepieceDivergenceAngleRad) * scaling.eyepieceHalfWidth;
	points.eyepieceLength = {};
	points.eyepieceLength.upper = point(points.opticalPath.eyepieceLength.x - eyepieceHalfWidthX, points.opticalPath.eyepieceLength.y - eyepieceHalfWidthY);
	points.eyepieceLength.lower = point(points.opticalPath.eyepieceLength.x + eyepieceHalfWidthX, points.opticalPath.eyepieceLength.y + eyepieceHalfWidthY);
	// draw line
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.eyepieceLength.upper, points.eyepieceLength.lower);

	// secondary

	// scaling
	scaling.secondaryUpperEndHorizontalLength = scalingFactor * binoscopeModel.secondaryUpperEndHorizontalLength;
	scaling.secondaryUpperEndVerticalLength = scalingFactor * binoscopeModel.secondaryUpperEndVerticalLength;
	scaling.secondaryLowerEndHorizontalLength = scalingFactor * binoscopeModel.secondaryLowerEndHorizontalLength;
	scaling.secondaryLowerEndVerticalLength = scalingFactor * binoscopeModel.secondaryLowerEndVerticalLength;
	// points
	points.secondary = {};
	points.secondary.upperEnd = point(points.opticalPath.secondary.x + scaling.secondaryUpperEndHorizontalLength,  points.opticalPath.secondary.y - scaling.secondaryUpperEndVerticalLength);
	points.secondary.lowerEnd = point(points.opticalPath.secondary.x + scaling.secondaryLowerEndHorizontalLength,  points.opticalPath.secondary.y - scaling.secondaryLowerEndVerticalLength);
	// draw secondary
	drawLine(context, config.canvasGlassStyle, config.canvasLineWidth, points.secondary.upperEnd, points.secondary.lowerEnd);
	// draw mirror ends to P1, which should intersect diagonal ends
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.mirror.upperFace, points.P1);
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.mirror.lowerFace, points.P1);

	// P2

	// scaling
	scaling.P2EndHorizontalLength = scalingFactor * binoscopeModel.P2EndHorizontalLength;
	scaling.P2EndVerticalLength = scalingFactor * binoscopeModel.P2EndVerticalLength;
	// points
	points.P2 = {};
	points.P2.upperEnd = point(points.opticalPath.P2.x + scaling.P2EndHorizontalLength, points.opticalPath.P2.y - scaling.P2EndVerticalLength);
	points.P2.lowerEnd = point(points.opticalPath.P2.x - scaling.P2EndHorizontalLength, points.opticalPath.P2.y + scaling.P2EndVerticalLength);
	// draw P2 field dia
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.P2.upperEnd, points.P2.lowerEnd);
	// draw from secondary ends to P2 field ends
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.secondary.upperEnd, points.P2.upperEnd);
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.secondary.lowerEnd, points.P2.lowerEnd);

	// P3 (focal plane field)

	// scaling
	scaling.P3EndHorizontalLength = scalingFactor * binoscopeModel.P3EndHorizontalLength;
	scaling.P3EndVerticalLength = scalingFactor * binoscopeModel.P3EndVerticalLength;
	// points
	points.P3 = {};
	points.P3.upperEnd = point(points.opticalPath.focalPlane.x - scaling.P3EndHorizontalLength, points.opticalPath.focalPlane.y - scaling.P3EndVerticalLength);
	points.P3.lowerEnd = point(points.opticalPath.focalPlane.x + scaling.P3EndHorizontalLength, points.opticalPath.focalPlane.y + scaling.P3EndVerticalLength);
	// draw P3 field dia
	drawLine(context, config.canvasOpticalPathStyle, config.canvasLineWidth, points.P3.upperEnd, points.P3.lowerEnd);

	// tertiary

	// scaling
	scaling.tertiaryUpperPointHorizontalLength = scalingFactor * binoscopeModel.tertiaryUpperPointHorizontalLength;
	scaling.tertiaryUpperPointVerticalLength = scalingFactor * binoscopeModel.tertiaryUpperPointVerticalLength;
	scaling.tertiaryUpperLength = scalingFactor * binoscopeModel.tertiaryUpperLength;
	scaling.tertiaryLowerPointHorizontalLength = scalingFactor * binoscopeModel.tertiaryLowerPointHorizontalLength;
	scaling.tertiaryLowerPointVerticalLength = scalingFactor * binoscopeModel.tertiaryLowerPointVerticalLength;
	scaling.tertiaryLowerLength = scalingFactor * binoscopeModel.tertiaryLowerLength;
	// points
	points.tertiary = {};
	points.tertiary.upperEnd = point(points.opticalPath.tertiary.x + scaling.tertiaryUpperPointHorizontalLength, points.opticalPath.tertiary.y - scaling.tertiaryUpperPointVerticalLength);
	points.tertiary.lowerEnd = point(points.opticalPath.tertiary.x + scaling.tertiaryLowerPointHorizontalLength, points.opticalPath.tertiary.y - scaling.tertiaryLowerPointVerticalLength);
	// draw tertiary
	drawLine(context, config.canvasGlassStyle, config.canvasLineWidth, points.tertiary.upperEnd, points.tertiary.lowerEnd);
	// draw tertiary ends to P3 (focal plane field)
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.tertiary.upperEnd, points.P3.upperEnd);
	drawLine(context, config.canvasOpticalPathAltStyle, config.canvasLineWidth, points.tertiary.lowerEnd, points.P3.lowerEnd);
	...
	text = config.primaryMirrorToSecondaryMirrorText + roundToDecimal(binoscopeModel.primaryMirrorToSecondaryHorizontalLength, config.decimalPointsDimension) + uomLengthLit;
	dimensionY += 4 * config.canvasDimensionHalfHeight;
	drawHorizDimen(context, text, dimensionY, points.mirror.center.x, points.opticalPath.secondary.x, config.canvasTextBorder, config.canvasLineWidth, config.canvasStructureLightStyle);

	// draw primary to focal plane, P3
	text = config.primaryMirrorToP3MirrorText + roundToDecimal(binoscopeModel.primaryMirrorToFocalPlaneHorizontalLength, config.decimalPointsDimension) + uomLengthLit;
	dimensionY += 4 * config.canvasDimensionHalfHeight;
	drawHorizDimen(context, text, dimensionY, points.mirror.center.x, points.P3.lowerEnd.x, config.canvasTextBorder, config.canvasLineWidth, config.canvasStructureLightStyle);

	// draw P3 to eyepiece end
	text = config.primaryMirrorToEyepieceEndText + roundToDecimal(binoscopeModel.primaryMirrorToEyepieceEndHorizontalLength, config.decimalPointsDimension) + uomLengthLit;
	dimensionY += 4 * config.canvasDimensionHalfHeight;
	drawHorizDimen(context, text, dimensionY, points.mirror.center.x, points.opticalPath.eyepieceLength.x, config.canvasTextBorder, config.canvasLineWidth, config.canvasStructureLightStyle);

	// draw labels
	drawText(context, 'P1', points.P1, config.canvasStructureLightStyle);
	drawText(context, 'P2', points.opticalPath.P2, config.canvasStructureLightStyle);
	drawText(context, 'P3', points.opticalPath.focalPlane, config.canvasStructureLightStyle);
	drawText(context, 'eyepiece end', points.opticalPath.eyepieceLength, config.canvasStructureLightStyle);
	drawText(context, 'primary', points.mirror.upperFace, config.canvasStructureLightStyle);
	drawText(context, 'secondary', points.secondary.upperEnd, config.canvasStructureLightStyle);
	drawText(context, 'tertiary', points.tertiary.upperEnd, config.canvasStructureLightStyle);
	...
	resultsString = 'secondary mirror: tilted at '
			+ roundToDecimal(binoscopeModel.secondaryAngleDeg, config.decimalPointsDimension)
			+ ' deg; size = '
			+ roundToDecimal(binoscopeModel.secondaryMinorAxisLength, config.decimalPointsDimension)
			+ 'x'
			+ roundToDecimal(binoscopeModel.secondaryMajorAxisLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ ', minor axis x major axis'
			+ ', offset along secondary face = '
			+ roundToDecimal(binoscopeModel.secondaryOffset, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>tertiary mirror:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;tilted at '
			+ roundToDecimal(binoscopeModel.tertiaryAngleDeg, config.decimalPointsDimension)
			+ ' deg; maximum size = '
			+ roundToDecimal(binoscopeModel.tertiaryMinorAxisLength, config.decimalPointsDimension)
			+ 'x'
			+ roundToDecimal(binoscopeModel.tertiaryLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ ', minor axis x major axis'
			+ ', offset along tertiary face = '
			+ roundToDecimal(binoscopeModel.tertiaryOffset, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>vertical height: secondary to tertiary = '
			+ roundToDecimal(binoscopeModel.secondaryToTertiaryVerticalLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>vertical height: secondary to focal point = '
			+ roundToDecimal(binoscopeModel.primaryMirrorToFocalPlaneVerticalLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>vertical height: tertiary to focal plane = '
			+ roundToDecimal(binoscopeModel.tertiaryToFocalPlaneVerticalLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>vertical height: top of primary mirror to focal point = '
			+ roundToDecimal(binoscopeModel.primaryMirrorEdgeToFocalPlaneVerticalLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>vertical height: top of primary mirror to eyepiece end = '
			+ roundToDecimal(binoscopeModel.primaryMirrorEdgeToEyepieceEndVerticalLength, config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>field diameter as set in the diagonal designer = '
			+ roundToDecimal(common.maxFieldDiaDiagVal(), config.decimalPointsDimension)
			+ uomLengthLit
			+ '<br>equivalent monoscope aperture for stars = '
			...
			+ uomLengthLit
			+ '; &emsp; equivalent monoscope aperture for nebulosity = '
...
MLB.NewtDesigner.graphBinoscopeFrontView = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		primaryMirrorsEdgeToEdgeSeparation,
		humanFaceWidthUom,
		humanFaceHeightUom,
	...
	// build canvas, context
	common.binoscopeFrontViewCanvasDiv().append(buildCanvasElement('binoscopeFrontViewCanvas', common.baffleCanvasID().width / 2, common.baffleCanvasID().height));
	...
	// get user input vars
	IPD = common.IPDVal();
	IPDUom = common.convertMmToUom(IPD);
	...
	// draw human adult face, shoulders, eyes

	// convert human face measurements to user set uom
	...
	humanEyeRadiusUom = common.convertInchesToUom(config.humanEyeRadiusInches);
	// scaling
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderBinoscopeScaleValue);
	scaling.IPD = scalingFactor * IPDUom;
	...
	scaling.humanEyeRadiusUom = scalingFactor * humanEyeRadiusUom;
	...
	y = canvas.height / 2;
	points.IPD = {};
	points.IPD.rightEye = point(midX + scaling.IPD / 2, y);
	points.IPD.leftEye = point(midX - scaling.IPD / 2, y);
	// draw head
	fillEllipse(context, config.canvasHumanStyle, 2, canvas.width / 2, y, scaling.humanFaceWidthUom / 2, scaling.humanFaceHeightUom / 2, 0, Math.PI * 2);
	// draw shoulder
	shoulderRect = rect((canvas.width - scaling.humanShoulderWidthUom) / 2, y + scaling.humanEyeToShoulderUom, scaling.humanShoulderWidthUom, scaling.humanShoulderDepthUom);
	fillRect(context, config.canvasHumanStyle, shoulderRect);
	// draw neck
	neckRect = rect((canvas.width - scaling.humanNeckWidthUom) / 2, y, scaling.humanNeckWidthUom, scaling.humanShoulderDepthUom);
	fillRect(context, config.canvasHumanStyle, neckRect);
	// draw eyes
	fillCircle(context, points.IPD.rightEye, scaling.humanEyeRadiusUom, config.canvasHumanEyeStyle);
	fillCircle(context, points.IPD.leftEye, scaling.humanEyeRadiusUom, config.canvasHumanEyeStyle);

	// draw primary mirrors

	// scaling
	scaling.aperture = scalingFactor * binoscopeModel.mirrorDia;
	scaling.primaryMirrorToEyepieceEndVerticalLength = scalingFactor * binoscopeModel.primaryMirrorToEyepieceEndVerticalLength;
	// points
	points.primaryMirror = {};
	points.primaryMirror.right = point(points.IPD.rightEye.x + scaling.primaryMirrorToEyepieceEndVerticalLength * Math.cos(binoscopeSecondaryAxisDownwardTiltAngleRad), points.IPD.rightEye.y - scaling.primaryMirrorToEyepieceEndVerticalLength * Math.sin(binoscopeSecondaryAxisDownwardTiltAngleRad));
	points.primaryMirror.left = point(points.IPD.leftEye.x - scaling.primaryMirrorToEyepieceEndVerticalLength * Math.cos(binoscopeSecondaryAxisDownwardTiltAngleRad), points.IPD.leftEye.y - scaling.primaryMirrorToEyepieceEndVerticalLength * Math.sin(binoscopeSecondaryAxisDownwardTiltAngleRad));
	// draw mirrors
	drawCircle(context, points.primaryMirror.right, scaling.aperture / 2, config.canvasLineWidth, config.canvasStructureStyle);
	drawCircle(context, points.primaryMirror.left, scaling.aperture / 2, config.canvasLineWidth, config.canvasStructureStyle);

	// draw eye to primary mirror center
	drawLine(context, config.canvasGlassStyle, config.canvasLineWidth, points.primaryMirror.right, points.IPD.rightEye);
	drawLine(context, config.canvasGlassStyle, config.canvasLineWidth, points.primaryMirror.left, points.IPD.leftEye);

	// calc primary mirrors separation here (not in calcLib calcBinoscope2 because IPD and uom issues are best dealt with here
	primaryMirrorsEdgeToEdgeSeparation = IPDUom + 2 * binoscopeModel.primaryMirrorToEyepieceEndVerticalLength * Math.cos(binoscopeSecondaryAxisDownwardTiltAngleRad) - binoscopeModel.mirrorDia;
	eyepieceTipdownFromSecToTertTipdownAndTertBend = calcEyepieceTipdownFromSecToTertTipdownAndTertBend(binoscopeModel.eyepieceDivergenceAngleDeg, binoscopeSecondaryAxisDownwardTiltAngleDeg);

	// dimension: mirror edge separation
	text = config.mirrorEdgesSeparation + roundToDecimal(primaryMirrorsEdgeToEdgeSeparation, config.decimalPointsDimension) + uomLengthLit;
	drawHorizDimen(context, text, points.primaryMirror.right.y, points.primaryMirror.left.x + scaling.aperture / 2, points.primaryMirror.right.x - scaling.aperture / 2, config.canvasTextBorder, config.canvasLineWidth, config.canvasStructureLightStyle);

	// write results
	resultsString = 'Eyepiece tipdown angle = '
			+ roundToDecimal(eyepieceTipdownFromSecToTertTipdownAndTertBend, config.decimalPointsDimension)
			+ ' deg due to optical axis downward tilt and eyepiece divergence';
...
MLB.NewtDesigner.graphRocker = () => {
	...
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderRockerScaleValue);
...
MLB.NewtDesigner.graphFlexRocker = () => {
	...
	// readjust per user scaling
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderFlexRockerScaleValue);
...
MLB.NewtDesigner.graphEquatorialTable = () => {
	...
	// adjust scaling
	scalingFactor = adjustScaling(state.scaling.scalingFactor, state.sliderETScaleValue);

	// get scaled dimens
	platform = setEquatorialTableStandardPlatformCG();
	scaledRockerSideLength = scalingFactor * state.rocker.length;
	scaledRockerFrontWidth = scalingFactor * state.rocker.width;
	scaledPlatformThickness = scalingFactor * platform.thickness;
	scaledETCGToPlatformBottom = scalingFactor * platform.CG.combined;

	// for flex rocker
	flexRockerPlatform = setEquatorialTableFlexRockerPlatformCG();
	/*
	scaledRockerSideLength = scalingFactor * state.flexRocker.baseRing.outerRadius * 2;
	scaledRockerFrontWidth = scaledRockerSideLength;
	scaledPlatformThickness = scalingFactor * state.flexRocker.baseRing.height;
	scaledETCGToPlatformBottom = scalingFactor * flexRockerPlatform.CG.combined;
	*/
	...
	// save values
	southTrack.radius = frontViewSouthTrackArc.radius / scalingFactor;
	southTrack.bearingSeparationAngleDeg = frontViewSouthTrackArc.bearingAngleRad * 2 / uom.degToRad;
	southTrack.arcWidth = frontViewSouthDrawnArc.width / scalingFactor;

	northTrack.radius = frontViewNorthTrackArc.radius / scalingFactor;
	northTrack.bearingSeparationAngleDeg = frontViewNorthTrackArc.bearingAngleRad * 2 / uom.degToRad;
	northTrack.arcWidth = frontViewNorthDrawnArc.width / scalingFactor;
...
MLB.NewtDesigner.updateFieldsDependentOnTelescopeFocalLength = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		distanceToObject = +common.distanceToObject().val();
...
MLB.NewtDesigner.updateAEF = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
		eyepiecesJson = MLB.NewtDesigner.eyepiecesJsonSelector(),
...
MLB.NewtDesigner.getEyepieceCCMag = (manufacturer, type, focalLengthmm) => {
	var eyepiecesJson = MLB.NewtDesigner.eyepiecesJsonSelector();
...
// ie, when coma corrector is added/removed/changed
MLB.NewtDesigner.updateEyepieceOptimizerRows = () => {
	var config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
		getSelectedEyepiece = MLB.NewtDesigner.getSelectedEyepiece,
		calculateAndUpdateEyepieceFields = MLB.NewtDesigner.calculateAndUpdateEyepieceFields,
		manufacturer,
		type,
	...
	// update fields for all selected eyepieces
	for (rowIx = 0; rowIx < config.maxEyepieceRows; rowIx += 1) {
		if (getSelectedEyepiece(rowIx)) {
			manufacturer = common.tableElement(config.EyeOptManufacturerID, rowIx).html();
			type = common.tableElement(config.EyeOptTypeID, rowIx).html();
			eyepieceFocalLengthmm = parseFloat(common.tableElement(config.EyeOptFocalLengthID, rowIx).html());
			eyepieceFieldStopmm = parseFloat(common.tableElement(config.EyeOptFieldStopID, rowIx).html());

			calculateAndUpdateEyepieceFields(manufacturer, type, eyepieceFocalLengthmm, eyepieceFieldStopmm, rowIx);
		}
	}
};

MLB.NewtDesigner.setEyeOptSelectedEyepiece = function (rowIx, jsonEyepieceIx) {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
		eyepiecesJson = MLB.NewtDesigner.eyepiecesJsonSelector(),
		eyepiece = eyepiecesJson.eyepieces[jsonEyepieceIx],
		calculateAndUpdateEyepieceFields = MLB.NewtDesigner.calculateAndUpdateEyepieceFields;

	common.tableElement(config.EyeOptManufacturerID, rowIx).html(eyepiece.manufacturer);
	common.tableElement(config.EyeOptTypeID, rowIx).html(eyepiece.type);
	common.tableElement(config.EyeOptFocalLengthID, rowIx).html(roundToDecimal(+eyepiece.focalLengthmm, config.decimalPointsEyepieceFL) + config.mmLitNS);
	common.tableElement(config.EyeOptFieldStopID, rowIx).html(roundToDecimal(+eyepiece.fieldStopmm, config.decimalPointsEyepieceFieldStop) + config.mmLitNS);
	common.tableElement(config.EyeOptApparentFieldID, rowIx).html(roundToDecimal(+eyepiece.apparentField, config.decimalPointsEyepieceApparentFOV) + config.degLitNS);

	calculateAndUpdateEyepieceFields(eyepiece.manufacturer, eyepiece.type, +eyepiece.focalLengthmm, +eyepiece.fieldStopmm, rowIx);
};

MLB.NewtDesigner.calculateAndUpdateEyepieceFields = (manufacturer, type, focalLengthmm, fieldStopmm, rowIx) => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
	...
	CCMag = getEyepieceCCMag(manufacturer, type, focalLengthmm);
	if (CCMag != '') {
		comaCorrectorMag = +CCMag;
	}
	magnification = aperture * focalRatio / focalLengthmm * 25.4 * comaCorrectorMag;
	magnificationPerInch = focalRatio / focalLengthmm * 25.4 * comaCorrectorMag;
	resolutionArcsec = resolutionFromAperture_Magnification(aperture, magnification);
	resultFOV = calcFOVFromAperture_FocalRatio_EyepieceFieldStop_ComaCorrectorFactor(aperture, focalRatio, fieldStopmm, comaCorrectorMag);
	exitPupil = focalLengthmm / focalRatio / comaCorrectorMag;
	highMagnitudeLimit = limitingMagnitude(apertureInches);
	...
	coma = calcGreaterComaWithComaCorrector(fieldStopmm, focalRatio, common.useComaCorrectorMagnificationVal());

	common.tableElement(config.EyeOptExitPupilID, rowIx).html(roundToDecimal(exitPupil, config.decimalPointsEyePupil) + config.mmLitNS);
	common.tableElement(config.EyeOptFOVID, rowIx).html(roundToDecimal(resultFOV, config.decimalPointsFOV) + config.degLitNS);
	common.tableElement(config.EyeOptMagnificationID, rowIx).html(roundToDecimal(magnification, config.decimalPointsMagnification) + 'x');
	common.tableElement(config.EyeOptMagnificationPerInchID, rowIx).html(roundToDecimal(magnificationPerInch, config.decimalPointsMagnification) + 'x/inch');
	common.tableElement(config.EyeOptResolutionID, rowIx).html(roundToDecimal(resolutionArcsec, config.decimalPointsResolution) + '"');
	common.tableElement(config.EyeOptLimitingMagnitudeID, rowIx).html(roundToDecimal(magnitudeLimit, config.decimalPointsLimitingMagnitude));
	common.tableElement(config.EyeOpEtendueID, rowIx).html(roundToDecimal(etendue, config.decimalPointsEtendue) /*+ config.etendueLit*/ );
	common.tableElement(config.EyeOptComaID, rowIx).html(roundToDecimal(coma, config.decimalPointsComaRMS) + config.comaRMSLit);
...
MLB.NewtDesigner.listWidestFieldEyepieces = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		topCount = config.widestEyepieceFOVTopDisplayCount,
...
MLB.NewtDesigner.copySelectedEyepieceToEyepieceTable = () => {
	...
	while (nextAvailRow < config.maxEyepieceRows) {
		if (!getSelectedEyepiece(nextAvailRow)) {
			break;
		}
		nextAvailRow += 1;
	}
	...
	// just want the 'Explore Scientific 100 series 30mm'
	selectedEyepieceMatch = selectedEyepieceCommaSplit[0];

	setEyeOptSelectedEyepieceUsingSelectStr(nextAvailRow, selectedEyepieceMatch);
};

// eg, if sorting by focal length then the passed in ix will be focalLengthIx: 3; if sorting by true field of view, then the passed in ix will be trueFieldOfViewIx: 7
MLB.NewtDesigner.sortEyepieceTable = function (ix) {
	var config = MLB.NewtDesigner.config,
		...
		populateEyepieceTableFromEyepieceArray = MLB.NewtDesigner.populateEyepieceTableFromEyepieceArray,
		selection,
		selectedEyepieceStr,
		sortedEyepieces = [];
	...
	Array
		...
		.sort(function (a, b) {
			...
			if (rowIx > 0) {
				selection = v.cells[0].children[0];
				selectedEyepieceStr = selection.options[selection.selectedIndex].text;
				if (selectedEyepieceStr != config.selectEyepieceLit) {
					sortedEyepieces.push(selectedEyepieceStr);
				}
			}
		});
		// not .forEach(row => eyepieceTable.appendChild(row));

	populateEyepieceTableFromEyepieceArray(sortedEyepieces);
};

MLB.NewtDesigner.populateEyepieceTableFromEyepieceArray = (eyepieces) => {
	var config = MLB.NewtDesigner.config,
		removeEyeOptSelectedEyepiece = MLB.NewtDesigner.removeEyeOptSelectedEyepiece,
		setEyeOptSelectedEyepieceUsingSelectStr = MLB.NewtDesigner.setEyeOptSelectedEyepieceUsingSelectStr,
		eyepieceIx;

	for (eyepieceIx = 0; eyepieceIx < config.maxEyepieceRows; eyepieceIx += 1) {
		removeEyeOptSelectedEyepiece(eyepieceIx);
	}
	eyepieces.forEach((v, eyepieceIx) => {
		setEyeOptSelectedEyepieceUsingSelectStr(eyepieceIx, v);
	});
};

MLB.NewtDesigner.listSelectedEyepieces = () => {
	var config = MLB.NewtDesigner.config,
		eyepieceTable = document.getElementById(config.eyepieceTableLit),
		rowIx,
		selection,
	...
	// 1st row is column headers, therefore loop to and include config.maxEyepieceRows
	for (rowIx = 1; rowIx <= config.maxEyepieceRows; rowIx += 1) {
		selection = eyepieceTable.rows[rowIx].cells[0].children[0];
		selectedEyepieceStr = selection.options[selection.selectedIndex].text;
		if (selectedEyepieceStr !== config.selectEyepieceLit) {
			selectedEyepieces.push(selectedEyepieceStr);
		}
	}
	return selectedEyepieces;
};
...
MLB.NewtDesigner.changeUom = function (ignoreLengthConversion) {
	...
	common.binoscopeEyepieceLengthLabel().html(config.binoscopeEyepieceLengthLabelLit + uomLengthLit + ' = ');
	...
	common.binoscopeEyepieceLength().val(roundToDecimal(common.binoscopeEyepieceLengthVal() * lengthConversionFactor, config.decimalPointsDiag));
...
// eyepiece manufacturer + type + FL
MLB.NewtDesigner.buildEyepieceString = function (eyepiece) {
	var config = MLB.NewtDesigner.config,
		fixEyepieceStr = MLB.NewtDesigner.fixEyepieceStr,
		str;

	str = eyepiece.manufacturer + ' ' + eyepiece.type + ' ' + eyepiece.focalLengthmm + config.mmLitNS;
	return fixEyepieceStr(str);
};

MLB.NewtDesigner.fixEyepieceStr = (str) => {
	return str.replace(/\s+/g, ' ').trim().replaceAll('.0m', 'm');
};

MLB.NewtDesigner.getSelectedEyepiece = (ix) => {
	var config = MLB.NewtDesigner.config,
		str;

	str = $('#' + config.EyeOptSelectID + ix).val();
	if (!str || str === '' || str === config.selectEyepieceLit) {
		return undefined;
	}
	return str;
};

// scan eyepiece Json, eg, 'APM: KUO XWA HDC 8.8mm' then add to table
MLB.NewtDesigner.setEyeOptSelectedEyepieceUsingSelectStr = function (eyepieceRow, eyepieceSelect) {
	var config = MLB.NewtDesigner.config,
		...
		eyepieceStr,
		matchedEyepieceStr,
		fixedEyepieceSelect = fixEyepieceStr(eyepieceSelect);

	$.each(eyepiecesJson.eyepieces, function (jsonEyepieceIx, v) {
		eyepieceStr = buildEyepieceString(v);
		if (fixedEyepieceSelect.includes(eyepieceStr)) {
			setEyeOptSelectedEyepiece(eyepieceRow, jsonEyepieceIx);
			matchedEyepieceStr = eyepieceStr;
		}
	});
	// copy to 'select eyepiece' column in eyepiece table
	if (matchedEyepieceStr) {
		$('#' + config.EyeOptSelectID + eyepieceRow).val(matchedEyepieceStr);
	}
};
...
MLB.NewtDesigner.removeEyeOptSelectedEyepiece = function (eyepieceRow) {
	...
	$('#' + config.EyeOptSelectID + eyepieceRow).val(config.selectEyepieceLit);
...
MLB.NewtDesigner.buildData = () => {
	var state = MLB.NewtDesigner.state,
		common = MLB.NewtDesigner.common,
		listSelectedEyepieces = MLB.NewtDesigner.listSelectedEyepieces,
		partElements,
		weightElements,
		distanceElements,
		verticalOffsetElements,
	...
	return {
		...
		eyepieceList: common.btnEyepieceListValue(),
		eyepieces: listSelectedEyepieces(),
		...
		binoscopeEyepieceDivergenceAngleDeg: common.binoscopeEyepieceDivergenceDegVal(),
		binoscopeEyepieceLength: common.binoscopeEyepieceLengthVal(),
		IPD: common.IPDVal(),
		binoscopeSecondaryAxisDownwardTiltAngleDeg: common.binoscopeSecondaryAxisDownwardTiltAngleDegVal(),
		CGs: CGs,
...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
	...
	if (parsedData.eyepieceList || parsedData.eyepieceList === '1') {
		// new eyepiece list
		common.btnEyepieceList()[1].checked = true;
	} else {
		// old eyepiece list (before March 2026)
		common.btnEyepieceList()[0].checked = true;
	}

	populateEyepieceTableFromEyepieceArray(parsedData.eyepieces);
	// if no eyepieces matched, then try matching to the other eyepiece list
	if (!getSelectedEyepiece(0)) {
		common.btnEyepieceList()[0].checked = !common.btnEyepieceList()[0].checked;
		common.btnEyepieceList()[1].checked = !common.btnEyepieceList()[1].checked;
		populateEyepieceTableFromEyepieceArray(parsedData.eyepieces);
	}
	...
	common.binoscopeEyepieceDivergenceAngleDeg().val(parsedData.binoscopeEyepieceDivergenceAngleDeg);
	...
	common.binoscopeEyepieceLength().val(parsedData.binoscopeEyepieceLength);
...
MLB.NewtDesigner.updateTelescopeResults = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		displayMinimumMeniscusMirrorThickness = MLB.NewtDesigner.displayMinimumMeniscusMirrorThickness,
		focalRatio = common.focalRatioVal(),
		aperture = common.apertureVal(),
		apertureInches = common.apertureInchesVal(),
	...
	common.telescopeDesignerResultsLabel().html('brightness gain = '
			...
			+ uomLengthLit
			+ "<label id='minimumMeniscusMirrorThicknessLabel' for=''> </label>"
	...
	common.chBoxIsMeniscus().change(function () {
		...
		displayMinimumMeniscusMirrorThickness(aperture, focalRatio);
	});
	
	// minimumMeniscusMirrorDia...
	displayMinimumMeniscusMirrorThickness(aperture, focalRatio);
...
MLB.NewtDesigner.displayMinimumMeniscusMirrorThickness = (aperture, focalRatio) => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		state = MLB.NewtDesigner.state,
		config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
		calcMinimumMeniscusMirrorDia = MLB.calcLib.calcMinimumMeniscusMirrorDia,
		uomLengthLit = common.getUomLengthLit();
		
	if (state.isMeniscus) {
		common.minimumMeniscusMirrorThicknessLabel().html('; &emsp; minimum meniscus mirror thickness given support on back edge = ' 
		+ roundToDecimal(calcMinimumMeniscusMirrorDia(aperture, focalRatio), config.decimalPointsDimension)
		+ uomLengthLit);
	} else {
		common.minimumMeniscusMirrorThicknessLabel().html('');
	}
};
...
MLB.NewtDesigner.updateMirrorCellFromMirrorSupportPoints = function (mirrorSupportPoints) {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		...
		maxRecommendedMirrorSurfaceAreaPerSupportPoint = config.maxRecommendedMirrorSurfaceAreaPerSupportPoint;
...
MLB.NewtDesigner.updateCurrentlySelectedDesigner = () => {
	...
	case config.designEyepiecesLit:
		...
		// nothing to do here as eyepieces are added/removed/imported elsewhere
		break;
	...
	for (eyepieceRow = 0; eyepieceRow < config.maxEyepieceRows; eyepieceRow++) {
		...
		if (manufacturerStr) {
			eyepieceStr = manufacturerStr
					...
					+ ' '
					+ common.tableElement(config.EyeOptApparentFieldID, eyepieceRow).html();
			// eg, eyepieceStr = 'Tele Vue: TVO Ethos 21.0mm 99.2deg'
...
MLB.NewtDesigner.processURLhash = () => {
	...
	case jumpTo.etendue:
	case jumpTo.EyeEtendueScopeObservation:
	case jumpTo.HET:
	case jumpTo.lowMags:
	...
	case jumpTo.diagonal:
		...
		break;
	case jumpTo.diagonalInterpretation:
		updateSelectedThenScrollToTop(common.btnDiagonalInterpretation(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, hash);
		break;
	case jumpTo.diagonalOffset:
		updateSelectedThenScrollToTop(common.btnDiagonalOffset(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, hash);
		break;
	case jumpTo.diagonalObstructionResolution:
		updateSelectedThenScrollToTop(common.btnDiagonalObstructionResolution(), config.btnSelectDiagonalLit, config.designDiagonalLit, config.designDiagonalImageLit, hash);
		break;
	...
	case jumpTo.mirrorEdgeSupport:
		...
		break;
	case jumpTo.mirrorMeniscus:
		updateSelectedThenScrollToTop(common.btnMirrorMeniscus(), config.btnSelectMirrorCellLit, config.designMirrorCellLit, config.designMirrorCellImageLit, hash);
		break;
	...
	case jumpTo.binoscope:
		...
		break;
	case jumpTo.binoscopeDivergentEyepieces:
		updateSelectedThenScrollToTop(common.btnBinoscopeDivergentEyepieces(), config.btnSelectBinoscopeLit, config.designBinoscopeLit, config.designBinoscopeImageLit, hash);
		break;
	...
	case jumpTo.binoscopeDesign:
		...
		break;
	// sub-section
	case jumpTo.binoscope3Dprinting:
		updateSelectedThenScrollToTop(common.btnBinoscopeDesign(), config.btnSelectBinoscopeLit, config.designBinoscopeLit, config.designBinoscopeImageLit, hash);
		break;
	case jumpTo.binoscopeHistory:
		updateSelectedThenScrollToTop(common.btnBinoscopeHistory(), config.btnSelectBinoscopeLit, config.designBinoscopeLit, config.designBinoscopeImageLit, hash);
		break;
	case jumpTo.binoscopeResources:
		updateSelectedThenScrollToTop(common.btnBinoscopeResources(), config.btnSelectBinoscopeLit, config.designBinoscopeLit, config.designBinoscopeImageLit, hash);
		break;
	// center of gravity
	case jumpTo.COG:
	...
	case jumpTo.Holcombe:
		updateSelectedThenScrollToTop(common.btnHolcomb(), config.btnSelectMountLit, config.designMountLit, config.designMountImageLit, hash);
		break;
	case jumpTo.Morse:
...
MLB.NewtDesigner.calcContrastFromObjAndSky = () => {
	var roundToDecimal = MLB.sharedLib.roundToDecimal,
		config = MLB.NewtDesigner.config,
		common = MLB.NewtDesigner.common,
		calcContrastOfObjectPlusSkyToSky2 = MLB.calcLib.calcContrastOfObjectPlusSkyToSky2,
		objSurfBright = common.objSurfBrightVal(),
		skySurfBright = common.skySurfBrightVal(),
		result;

	// returns contrastPercent, objectPlusSkyBackgroundSurfaceBrightness
	result = calcContrastOfObjectPlusSkyToSky2(objSurfBright, skySurfBright);

	common.ContrastCalcLabel().html('contrast of object+sky to the sky is '
			+ roundToDecimal(result.contrastPercent, config.decimalPointsPercent)
			+ '%; object+sky surface brightness is '
			+ roundToDecimal(result.objectPlusSkyBackgroundSurfaceBrightness, config.decimalPointsMagnitude)
			+ ' MPAS'
	);
};
...
$(window).ready(function () {
	var state = MLB.NewtDesigner.state,
		...
		calcContrastFromObjAndSky = MLB.NewtDesigner.calcContrastFromObjAndSky,
		BortleScale = MLB.BortleScaleJson.BortleScale,
		BortleScaleNum,
		updateMirrorCellFromRadioBtns = MLB.NewtDesigner.updateMirrorCellFromRadioBtns,
		graphBaffles = MLB.NewtDesigner.graphBaffles,
		graphFocuserBaffles = MLB.NewtDesigner.graphFocuserBaffles,
		sliderBinoscopeFocalPlaneToSecondaryDistanceValue,
		sliderBinoscopeFocalPlaneToTertiaryDistanceValue,
		...
		sliderBinoscopeIPDValue,
		sliderBinoscopeEyepieceLengthValue,
		calcCG = MLB.NewtDesigner.calcCG,
		graphRocker = MLB.NewtDesigner.graphRocker,
		graphLowrider = MLB.NewtDesigner.graphLowrider,
		graphFlexRocker = MLB.NewtDesigner.graphFlexRocker,
	...
	// Calculate aperture, focal ratio and etendue based on eyepiece, eye pupil and field of view
	...
	// focus change when object is close
	...
	common.btnEyepieceList().click(() => {
		var eyepieceRow;

		//empty eyepiece table
		for (eyepieceRow = 0; eyepieceRow < config.maxEyepieceRows; eyepieceRow += 1) {
	...
	common.objSurfBright().change(calcContrastFromObjAndSky);
	common.skySurfBright().change(calcContrastFromObjAndSky);
	...
	common.sliderBaffleScale().mousedown(function () {MLB.NewtDesigner.state.sliderBaffleScaleChanging = true; });
	common.sliderBaffleScale().mouseup(function () {MLB.NewtDesigner.state.sliderBaffleScaleChanging = false; });
	common.sliderBaffleScale().mousemove(function () {
		if (!state.sliderBaffleScaleChanging) {
			return;
		}
		state.sliderBaffleScaleValue = common.sliderBaffleScaleVal();
		graphBaffles();
	});
	common.sharedDiagSize().change(graphBaffles);
	common.diagOffset().change(graphBaffles);

	common.btnPlotFocuserBaffle().click(graphFocuserBaffles);

	common.sliderFocuserScale().mousedown(function () {MLB.NewtDesigner.state.sliderFocuserScaleChanging = true; });
	common.sliderFocuserScale().mouseup(function () {MLB.NewtDesigner.state.sliderFocuserScaleChanging = false; });
	common.sliderFocuserScale().mousemove(function () {
		if (!state.sliderFocuserScaleChanging) {
			return;
		}
		state.sliderFocuserScaleValue = common.sliderFocuserScaleVal();
		graphFocuserBaffles();
	});
	...
	common.lowriderSecondaryMirrorSize().change(graphLowrider);
	common.lowriderSecondaryOffset().change(graphLowrider);
	common.focalPlaneToSecondaryDistance().change(graphLowrider);
	common.focalPointPerpendicularOffsetFromEdgeOfPrimary().change(graphLowrider);
	common.btnUpdateLowrider().click(graphLowrider);

	common.sliderLowriderScale().mousedown(function () {MLB.NewtDesigner.state.sliderLowriderScaleChanging = true; });
	common.sliderLowriderScale().mouseup(function () {MLB.NewtDesigner.state.sliderLowriderScaleChanging = false; });
	common.sliderLowriderScale().mousemove(function () {
		if (!state.sliderLowriderScaleChanging) {
			return;
		}
		state.sliderLowriderScaleValue = common.sliderLowriderScaleVal();
		graphLowrider();
	});

	// binoscope designer

	common.binoscopeFocalPlaneToSecondaryDistance().change(binoscopeWorkflow);
	common.sliderBinoscopeFocalPlaneToSecondaryDistance().mousedown(function () {MLB.NewtDesigner.state.sliderBinoscopeFocalPlaneToSecondaryDistanceChanging = true; });
	common.sliderBinoscopeFocalPlaneToSecondaryDistance().mouseup(function () {MLB.NewtDesigner.state.sliderBinoscopeFocalPlaneToSecondaryDistanceChanging = false; });
	common.sliderBinoscopeFocalPlaneToSecondaryDistance().mousemove(function () {
		if (!state.sliderBinoscopeFocalPlaneToSecondaryDistanceChanging) {
			return;
		}
		sliderBinoscopeFocalPlaneToSecondaryDistanceValue = common.sliderBinoscopeFocalPlaneToSecondaryDistanceVal();
		// input number box
		common.binoscopeFocalPlaneToSecondaryDistance().val(sliderBinoscopeFocalPlaneToSecondaryDistanceValue);
		binoscopeWorkflow();
	});

	common.binoscopeFocalPlaneToTertiaryDistance().change(binoscopeWorkflow);
	common.sliderBinoscopeFocalPlaneToTertiaryDistance().mousedown(function () {MLB.NewtDesigner.state.sliderBinoscopeFocalPlaneToTertiaryDistanceChanging = true; });
	common.sliderBinoscopeFocalPlaneToTertiaryDistance().mouseup(function () {MLB.NewtDesigner.state.sliderBinoscopeFocalPlaneToTertiaryDistanceChanging = false; });
	common.sliderBinoscopeFocalPlaneToTertiaryDistance().mousemove(function () {
		if (!state.sliderBinoscopeFocalPlaneToTertiaryDistanceChanging) {
			return;
		}
		sliderBinoscopeFocalPlaneToTertiaryDistanceValue = common.sliderBinoscopeFocalPlaneToTertiaryDistanceVal();
		// input number box
		common.binoscopeFocalPlaneToTertiaryDistance().val(sliderBinoscopeFocalPlaneToTertiaryDistanceValue);
		binoscopeWorkflow();
	});

	common.binoscopeSecondaryBendingAngleDeg().change(binoscopeWorkflow);
	...
	common.binoscopeEyepieceDivergenceAngleDeg().change(binoscopeWorkflow);
	...
	common.sliderBinoscopeEyepieceDivergenceDeg().mousemove(function () {
		...
		// input number box
		common.binoscopeEyepieceDivergenceAngleDeg().val(sliderBinoscopeEyepieceDivergenceDegValue);
		binoscopeWorkflow();
	});

	common.IPD().change(binoscopeWorkflow);
	common.sliderBinoscopeIPD().mousedown(function () {MLB.NewtDesigner.state.sliderBinoscopeIPDChanging = true; });
	common.sliderBinoscopeIPD().mouseup(function () {MLB.NewtDesigner.state.sliderBinoscopeIPDChanging = false; });
	common.sliderBinoscopeIPD().mousemove(function () {
		if (!state.sliderBinoscopeIPDChanging) {
			return;
		}
		sliderBinoscopeIPDValue = common.sliderBinoscopeIPDVal();
		// input number box
		common.IPD().val(sliderBinoscopeIPDValue);
		binoscopeWorkflow();
	});

	common.binoscopeEyepieceLength().change(binoscopeWorkflow);
	common.sliderBinoscopeEyepieceLength().mousedown(function () {MLB.NewtDesigner.state.sliderBinoscopeEyepieceLengthChanging = true; });
	common.sliderBinoscopeEyepieceLength().mouseup(function () {MLB.NewtDesigner.state.sliderBinoscopeEyepieceLengthChanging = false; });
	common.sliderBinoscopeEyepieceLength().mousemove(function () {
		if (!state.sliderBinoscopeEyepieceLengthChanging) {
			return;
		}
		sliderBinoscopeEyepieceLengthValue = common.sliderBinoscopeEyepieceLengthVal();
		// input number box
		common.binoscopeEyepieceLength().val(sliderBinoscopeEyepieceLengthValue);
		binoscopeWorkflow();
	});

	common.sliderBinoscopeScale().mousedown(function () {MLB.NewtDesigner.state.sliderBinoscopeScaleChanging = true; });
	common.sliderBinoscopeScale().mouseup(function () {MLB.NewtDesigner.state.sliderBinoscopeScaleChanging = false; });
	common.sliderBinoscopeScale().mousemove(function () {
		if (!state.sliderBinoscopeScaleChanging) {
			return;
		}
		state.sliderBinoscopeScaleValue = common.sliderBinoscopeScaleVal();
		binoscopeWorkflow();
	});
	...
	common.sliderRockerScale().mousedown(function () {MLB.NewtDesigner.state.sliderRockerScaleChanging = true; });
	common.sliderRockerScale().mouseup(function () {MLB.NewtDesigner.state.sliderRockerScaleChanging = false; });
	common.sliderRockerScale().mousemove(function () {
		if (!state.sliderRockerScaleChanging) {
			return;
		}
		state.sliderRockerScaleValue = common.sliderRockerScaleVal();
		graphRocker();
	});

	// flex rocker designer
	...
	common.sliderFlexRockerScale().mousedown(function () {MLB.NewtDesigner.state.sliderFlexRockerScaleChanging = true; });
	common.sliderFlexRockerScale().mouseup(function () {MLB.NewtDesigner.state.sliderFlexRockerScaleChanging = false; });
	common.sliderFlexRockerScale().mousemove(function () {
		if (!state.sliderFlexRockerScaleChanging) {
			return;
		}
		state.sliderFlexRockerScaleValue = common.sliderFlexRockerScaleVal();
		graphFlexRocker();
	});

	// ET (equatorial table) designer

	common.btnUpdateET().click(graphEquatorialTable);
	common.sliderETScale().mousedown(function () {MLB.NewtDesigner.state.sliderETScaleChanging = true; });
	common.sliderETScale().mouseup(function () {MLB.NewtDesigner.state.sliderETScaleChanging = false; });
	common.sliderETScale().mousemove(function () {
		if (!state.sliderETScaleChanging) {
			return;
		}
		state.sliderETScaleValue = common.sliderETScaleVal();
		graphEquatorialTable();
	});
	...
	seedComaCorrector(config.comaCorrectorManufacturer, config.comaCorrectorModel, common.AEFComaCorrectorSelect, common.AEFComaCorrectorMag);
	common.AEFEyepieceSelect().val(config.eyepiece1);
	updateAEF();

	seedComaCorrector(config.comaCorrectorManufacturer, config.comaCorrectorModel, common.comaCorrectorSelect, common.comaCorrectorMag);
	setEyeOptSelectedEyepieceUsingSelectStr(0, config.eyepiece1);
	setEyeOptSelectedEyepieceUsingSelectStr(1, config.eyepiece2);
	setEyeOptSelectedEyepieceUsingSelectStr(2, config.eyepiece3);
