...
MLB.NewtDesigner.calcCG = function () {
    ...
    CG.heightToClearRockerBottomDistance = Math.sqrt(Math.pow(common.telescopeTubeODVal() / 2, 2) + Math.pow(state.tubeBackEndToFocalPlaneDistance - telescopeFocalLength + CG.CG, 2));
