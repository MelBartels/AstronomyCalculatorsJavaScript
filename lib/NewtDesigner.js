...
MLB.NewtDesigner.common = {
    ...
    btnBinoscopeSlave: function () {
        return $('[name=btnBinoscopeSlave]');
    },
    binoscopeSelectFocalPointToSecondaryDistanceOverSecondaryBendingAngle: function () {
        return this.btnBinoscopeSlave()[0].checked;
    },
    binoscopeSelectSecondaryBendingAngleOverFocalPointToSecondaryDistance: function () {
        return this.btnBinoscopeSlave()[1].checked;
    },
...
MLB.NewtDesigner.useSecondaryBendingAngle = function () {
    ...
    return common.binoscopeSelectSecondaryBendingAngleOverFocalPointToSecondaryDistance() && !isNaN(common.binoscopeSecondaryBendingAngleDegVal()) && common.binoscopeSecondaryBendingAngleDegVal() > 0;
};
...
MLB.NewtDesigner.binoscopeWorkflow = function () {
    ...
    if (useSecondaryBendingAngle()) {
        ...
        secondaryBendingAngleResults = calcBinoscopeSecondaryBendingAngle(
                common.apertureVal(),
                common.binoscopeFocalPointPerpendicularOffsetFromEdgeOfPrimaryVal(),
                common.binoscopeFocalPlaneToSecondaryDistanceVal(),
                common.binoscopeFocalPlaneToTertiaryDistanceVal(),
                common.binoscopeTertiaryBendingAngleDegVal());
...
MLB.NewtDesigner.graphBinoscope = function () {
    ...
    //mlb note todo
    // draw tertiary to focal plane (P3)
    drawLine(context, config.canvasGlassStyle, config.canvasLineWidth, points.tertiarySizedForP3Field.center, points.focalPlane2.center);
...
MLB.NewtDesigner.buildData = function () {
    ...
    return {
        ...
        btnBinoscopeSlave: common.binoscopeSelectFocalPointToSecondaryDistanceOverSecondaryBendingAngle(),
...
MLB.NewtDesigner.getDataUpdateUI = function (parsedData) {
    ...
    common.btnBinoscopeSlave()[0].checked = parsedData.btnBinoscopeSlave;
    common.btnBinoscopeSlave()[1].checked = !parsedData.btnBinoscopeSlave;
...
$(window).ready(function () {
    ...
    common.btnSetBinoscopeFocalPlaneToSecondaryToMinimumDistance().click(function () {
        // user cannot set minimum focal plane to secondary distance when secondary bending angle is setting the distance
        if (!useSecondaryBendingAngle()) {
            setBinoscopeFocalPlaneToSecondaryDistanceToMinimum();
        }
        binoscopeWorkflow();
    });
    common.btnBinoscopeSlave().click(binoscopeWorkflow);
