...
MLB.NewtDesigner.config = {
    version: 'Last updated 28-June-2020',
...
MLB.NewtDesigner.graphBinoscopeFrontView = function () {
    var roundToDecimal = MLB.sharedLib.roundToDecimal,
        ...
        drawLine = MLB.sharedLib.drawLine,
        drawEllipse = MLB.sharedLib.drawEllipse,
        uom = MLB.sharedLib.uom,
        uomLengthLit = common.getUomLengthLit(),
        canvas,
        context,
    ...
    drawEllipse(context, 'lightgray', 2, canvas.width / 2, points.leftFocalPoint.y, scaling.humanFaceWidthUom / 2, scaling.humanFaceHeightUom / 2, 0, Math.PI * 2);
