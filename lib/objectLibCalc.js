...
MLB.objectLibCalc.setupReader = function (onloadFunction) {
	...
	reader.onloadstart = function (e) {
		$('#status')[0].innerHTML = 'Reading file...';
	};
...
window.onload = function () {
	...
	$('#btnTranslate')[0].onclick = MLB.objectLibCalc.translateDescription;
	$('#btnAbortRead')[0].onclick = MLB.objectLibCalc.abortRead;
	$('#btnFile')[0].onchange = MLB.objectLibCalc.filesSelected;
	dropZone = $('#selectedFileDropDiv')[0];
