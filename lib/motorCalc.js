...
MLB.motorCalc.plot = function () {
	...
	initialDistance = +document.getElementsByName('initialDistance')[0].value;
	initialVel = +document.getElementsByName('initialVel')[0].value;
	endVel = +document.getElementsByName('endVel')[0].value;
	maxVel = +document.getElementsByName('maxVel')[0].value;
	accel = +document.getElementsByName('accel')[0].value;
