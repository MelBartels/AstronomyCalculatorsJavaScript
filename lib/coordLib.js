...
MLB.coordLib.TrackingRates = function () {
	var uom = MLB.sharedLib.uom,
		fiveMinutesTimeRad = 300 * uom.secToRad,
		fiveMinuteAzError,
		fiveMinuteAltError,
		savePosition = new MLB.coordLib.Position(),
	    workPositions = [];

	_(5).times(function () {
		workPositions.push(new MLB.coordLib.Position());
	});
	...
	this.getRatesViaDeltaTime = function (xform, timeIntervalSecs, HAOffset, includeRefraction) {
		...
		if (includeRefraction) {
			...
			xform.position.SidT = workPositions[1].SidT + fiveMinutesTimeRad;
		...
		fiveMinuteAzError = workPositions[4].az - workPositions[1].az - azRate1[0] / uom.sidRate / uom.secToRad * fiveMinutesTimeRad;
		fiveMinuteAltError = workPositions[4].alt - workPositions[1].alt - altRate1[0] / uom.sidRate / uom.secToRad * fiveMinutesTimeRad;
		...
		return {
			...
			fiveMinuteAzError: fiveMinuteAzError,
			fiveMinuteAltError: fiveMinuteAltError,
	...
	this.getKingRates = function (xform, timeIntervalSecs) {
		...
		xform.position.SidT += fiveMinutesTimeRad;
		getAltazTrig(xform.position, xform.meridianFlip, latitude);
		fiveMinuteAzError = xform.position.az - scopePosition.az - (KingRate0 + KingRate1) / 2 * uom.arcsecToRad / uom.sidRate / uom.secToRad * fiveMinutesTimeRad;
	...
	this.getRatesViaFormulaeNoRefraction = function (xform, timeIntervalSecs, HAOffset) {
		...
		fiveMinuteAzError = xform.position.az - workPositions[1].az - altazRates1.azRate / uom.sidRate / uom.secToRad * fiveMinutesTimeRad;
		fiveMinuteAltError = xform.position.alt - workPositions[1].alt - altazRates1.altRate / uom.sidRate / uom.secToRad * fiveMinutesTimeRad;
